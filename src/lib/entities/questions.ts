...
// 		answers: [
// 			'Le leggi della dinamica dei fluidi.',
// 			'Le leggi che regolano il moto di corpi solidi im mersi in un fluido gassoso.',
// 			"Lo spostamento delle masse d'aria nell'atmo sfera terrestre."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		answers: [
// 			'È un corpo di forma prestabilita che genera portanza aerodinamica in ogni condizione.',
// 			"È un corpo di forma appropriata che posto in movimento rispetto all'aria genera forze aero dinamiche.",
// 			"È un corpo di forma qualsiasi che genera solo portanza quando posto in movimento rispetto all'aria."
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		answers: [
// 			"La proiezione dell'ala sul piano orizzontale.",
// 			"La proiezione dell'ala sul piano verticale pas sante per le estremità alari.",
// 			"La sezione di un'ala, determinata su un piano perpendicolare all'asse trasversale."
// 		],
// 		correct_answer_index: 2
// 	},
...
// 			'Piano convesso ed ellittico simmetrico.',
// 			'Cavo convesso e biconvesso simmetrico.',
// 			'Concavo convesso, piano convesso e bicon vesso.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'Che cosa è la corda alare o aerodinamica?',
// 		answers: [
// 			"È il segmento di retta che unisce il bordo d'at tacco al bordo d'uscita del profilo alare.",
// 			"È il segmento di retta che identifica il piano di simmetria dell'ala.",
// 			'È la distanza tra le due estremità alari.'
// 		],
// 		correct_answer_index: 0
...
// 			'La distanza tra le due estremità alari.',
// 			"La distanza tra bordo d'attacco e bordo d'uscita del profilo alare.",
// 			"La massima distanza tra estradosso ed intra dosso dell'ala."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		id: '2012',
// 		section: 'AERODINAMICA',
// 		text: "Come si chiama il movimento di un'ala ri spetto al suo asse longitudinale?",
// 		answers: ['Rollio.', 'Imbardata.', 'Beccheggio.'],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '2013',
// 		section: 'AERODINAMICA',
// 		text: "Come si chiama il movimento di un'ala ri spetto al suo asse trasversale?",
// 		answers: ['Rollio.', 'Imbardata.', 'Beccheggio.'],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '2014',
// 		section: 'AERODINAMICA',
// 		text: "Come si chiama il movimento di un'ala ri spetto al suo asse verticale?",
// 		answers: ['Rollio.', 'Imbardata.', 'Beccheggio.'],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '2015',
// 		section: 'AERODINAMICA',
// 		text: 'L\'ala può essere considerata una "mac china"?',
// 		answers: [
// 			'No, perché priva di particolari meccanismi.',
// 			'Solo se dotata di superfici mobili.',
// 			'Si, perché trasforma un tipo di energia in ener gia di tipo diverso.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '2017',
// 		section: 'AERODINAMICA',
// 		text: 'Per quale motivo parlando di aerodina mica è necessario fare riferimento al "tubo di flusso"?',
// 		answers: [
// 			'Perché si usa fare così in fisica.',
// 			'Perché gli esperimenti in galleria del vento sono effettuati in un locale a forma di tubo.',
// 			'Perché le leggi dell\'aerodinamica che regolano il volo valgono all\'interno appunto di un tubo ideale detto "tubo di flusso".'
...
// 		answers: [
// 			'la presenza di un solido perturba comunque il flusso del fluido.',
// 			'la presenza di un solido opportunamente profi lato non disturba il flusso di un fluido.',
// 			'la presenza di un solido determina necessaria mente una variazione di portata.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '2020',
// 		section: 'AERODINAMICA',
// 		text: "Un profilo investito da aria in movimento determina gli stessi effetti aerodinamici di un pro filo che si muove nell'aria?",
// 		answers: [
// 			'No, indipendentemente dalla velocità e dire zione del movimento relativo.',
// 			'Si, ma solo se coincidono velocità e direzione del movimento relativo.',
// 			'Dipende solamente dalla forma del corpo so lido.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		text: 'Che cosa è il vento relativo?',
// 		answers: [
// 			"La differenza di velocità dell'aria che si riscon tra sulle due semiali in virata.",
// 			"Il vento incontrato dall'ala in quanto in movi mento o il movimento relativo dell'aria rispetto all'ala.",
// 			"La differenza di velocità dell'aria su estradosso ed intradosso dell'ala in volo."
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		text: "La velocità di cui è dotata un'ala e le forze a essa applicate quando vola sono:",
// 		answers: [
// 			"grandezze fisiche rappresentabili con vettori (con direzione, verso, intensità e punto d'appli cazione definiti) che si possono comporre o scomporre tra loro.",
// 			'grandezze fisiche che non si possono rappre sentare graficamente ma che possono som marsi e sottrarsi geometricamente.',
// 			'grandezze numeriche semplici con le quali è quindi possibile effettuare qualsiasi operazione.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		text: 'Che cosa è la pressione dinamica di un fluido?',
// 		answers: [
// 			'È il rapporto tra la velocità di un fluido in mo vimento e la sua densità.',
// 			'È il rapporto tra la velocità di un fluido in mo vimento e la superficie del solido immerso in esso.',
// 			'È la pressione che un fluido esercita sulla su perficie di un solido immerso in esso per effetto della velocità di scorrimento.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '2028',
// 		section: 'AERODINAMICA',
// 		text: 'La portanza e la resistenza sono diretta mente proporzionali:',
// 		answers: ['alla pressione statica.', 'alla pressione dinamica.', 'alla pressione totale.'],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		id: '2031',
// 		section: 'AERODINAMICA',
// 		text: 'Un profilo in volo genera una pressione di namica:',
// 		answers: [
// 			"maggiore sull'estradosso.",
// 			"minore sull'estradosso.",
// 			"identica sulle due superfici dell'ala."
...
// 			"che l'andamento della pressione statica del fluido non dipende da quello della pressione di namica dello stesso."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 			'Che variando la sezione del tubo, pressione e velocità del fluido rimangono invariate.',
// 			'Che variando la sezione del tubo, varia solo la pressione dinamica del fluido.',
// 			'Che variando la sezione del tubo variano velo cità, pressione statica e pressione dinamica. La pressione totale non varia.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '2035',
// 		section: 'AERODINAMICA',
// 		text: 'In un tubo di Venturi avente portata co stante, al variare della sezione:',
// 		answers: [
// 			'la velocità del fluido varia.',
// 			'la velocità del fluido non varia.',
// 			'la pressione totale del fluido varia.'
...
// 		id: '2036',
// 		section: 'AERODINAMICA',
// 		text: 'In un tubo di Venturi avente portata co stante la somma della pressione statica e della pressione dinamica del fluido (pressione totale):',
// 		answers: [
// 			'è variabile al variare della sezione.',
// 			'è costante al variare della sezione.',
// 			'dipende dalla densità del fluido.'
...
// 		text: "All'interno di un tubo di flusso a portata costante, se la sezione diminuisce:",
// 		answers: [
// 			'la velocità del fluido aumenta e la sua pres sione dinamica diminuisce.',
// 			'la velocità del fluido aumenta e la sua pres sione dinamica aumenta.',
// 			'la velocità del fluido aumenta e quindi la pres sione totale varia.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		text: "All'interno di un tubo di flusso a portata costante dove la sezione aumenta:",
// 		answers: [
// 			'la velocità del fluido diminuisce e la sua pres sione statica aumenta.',
// 			'la velocità del fluido diminuisce e la sua pres sione statica diminuisce.',
// 			'la velocità del fluido diminuisce e quindi la pres sione totale varia.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 			'perpendicolare alla traiettoria di volo o al vento relativo.',
// 			'sempre parallela alla traiettoria di volo o al vento relativo.',
// 			"diretta verso l'alto e per questo in grado di con trastare la forza peso."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		answers: [
// 			'la portanza perpendicolare alla corda alare e la resistenza parallela alla corda alare.',
// 			'la portanza perpendicolare alla traiettoria di volo od alla direzione del vento relativo, la re sistenza parallela ad esse.',
// 			'la portanza parallela al vento relativo od alla traiettoria di volo, la resistenza perpendicolare ad essi.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		answers: [
// 			'si genera portanza.',
// 			'non si genera portanza senza che si generi re sistenza.',
// 			'la resistenza generata dipende unicamente dalla forma del profilo.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		answers: [
// 			'la resistenza è uguale e opposta alla velocità sulla traiettoria.',
// 			'la resistenza a velocità costante, è uguale e op posta alla componente del peso lungo la traiet toria.',
// 			'la portanza e la resistenza si equilibrano.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '2048',
// 		section: 'AERODINAMICA',
// 		text: "In quale modo varia la resistenza aerodi namica di un'ala variando la densità dell'aria e la superficie dell'ala stessa?",
// 		answers: [
// 			'Non varia in alcun modo.',
// 			'Varia proporzionalmente.',
// 			'Varia in modo inversamente proporzionale.'
...
// 		text: 'Che cosa è il Cr?',
// 		answers: [
// 			'Un coefficiente numerico che dipende dal ca rico alare.',
// 			'Un coefficiente numerico che dipende dalla forma del profilo e dalla sua incidenza di volo.',
// 			'Una forza che dipende dalla forma del profilo e dalla sua incidenza di volo.'
// 		],
// 		correct_answer_index: 1
...
// 		answers: [
// 			'È la parte di resistenza dovuta alla forma più o meno aerodinamica di un corpo.',
// 			'È la parte di resistenza dovuta alle dimensioni del corpo indipendentemente dalla forma aero dinamica dello stesso.',
// 			'È una forza il cui valore può essere nullo se la forma del corpo è molto aerodinamica.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '2053',
// 		section: 'AERODINAMICA',
// 		text: 'Su quale tipo di resistenza influisce princi palmente lo spessore del profilo alare?',
// 		answers: [
// 			'Sulla resistenza di attrito.',
// 			'Sulla resistenza indotta.',
// 			'Sulla resistenza di forma.'
...
// 		answers: [
// 			"È la parte di resistenza dovuta alle dimensioni dell'ala.",
// 			"È la parte di resistenza dovuta all'attrito dell'a ria sulla superficie dell'ala.",
// 			'È la parte di resistenza dovuta alla presenza inevitabile dei vortici marginali.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		answers: [
// 			"È la parte di resistenza dovuta al prodursi dei vortici marginali o d'estremità alare.",
// 			"È la parte di resistenza dovuta all'attrito dell'a ria sulla superficie alare.",
// 			"È la parte di resistenza dovuta alla forma e alle dimensioni dell'ala."
// 		],
// 		correct_answer_index: 0
// 	},
...
// 			"dall'attrito dell'aria sulla superficie alare che produce i vortici marginali.",
// 			"dallo spessore più o meno rilevante dell'ala che oltre certi valori produce vortici marginali.",
// 			"dalla differenza di pressione statica sotto e so pra l'ala."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		answers: [
// 			'Si e da nessun altro parametro o fattore.',
// 			"Si, anche da esso ed è minore quando è mag giore l'allungamento.",
// 			'No.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '2063',
// 		section: 'AERODINAMICA',
// 		text: "A parità di altre condizioni un'ala con al lungamento maggiore:",
// 		answers: ['è più efficiente.', 'è meno efficiente.', 'è più resistente.'],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '2064',
// 		section: 'AERODINAMICA',
// 		text: "Lo scopo principale per cui si tende ad au mentare l'allungamento è:",
// 		answers: [
// 			'ottenere minore resistenza di forma.',
// 			"ottenere minore resistenza d'attrito.",
// 			'ottenere minore resistenza indotta.'
...
// 		id: '2065',
// 		section: 'AERODINAMICA',
// 		text: "L'unica resistenza che diminuisce all'au mentare della velocità è:",
// 		answers: ["quella d'attrito.", 'quella indotta.', 'quella di forma.'],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		id: '2069',
// 		section: 'AERODINAMICA',
// 		text: 'Si può diminuire la resistenza aerodina mica sino a ridurla a zero in volo?',
// 		answers: ["Si, variando opportunamente l'angolo d'inci denza", 'Si, in almeno due modi', 'No'],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '2070',
...
// 		text: 'La portanza, in un profilo convenzionale, è generata prevalentemente:',
// 		answers: [
// 			"dalla diminuzione di pressione statica in corri spondenza dell'estradosso.",
// 			"dalla diminuzione di pressione dinamica in cor rispondenda dell'estradosso.",
// 			"dall'aumento di pressione statica sull'estra dosso."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		answers: [
// 			'una forza perpendicolare alla traiettoria di volo o alla direzione del vento relativo.',
// 			"una velocità che dipende dall'incidenza del pro filo.",
// 			"un fattore numerico che dipende dal disegno e dall'incidenza del profilo."
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '2076',
// 		section: 'AERODINAMICA',
// 		text: 'Lo spessore del profilo influisce normal mente sul valore della portanza e della resistenza che esso genera?',
// 		answers: [
// 			"Si, la portanza mediamente aumenta mentre la resistenza diminuisce con l'aumentare dello spessore.",
// 			"Si, portanza e resistenza aumentano a parità di altre condizioni con l'aumentare dello spessore.",
// 			"Si, la portanza diminuisce mentre la resistenza mediamente aumenta con l'aumentare dello spessore."
...
// 		id: '2077',
// 		section: 'AERODINAMICA',
// 		text: "La portanza e la resistenza dipendono an che dalla densità dell'aria?",
// 		answers: ['Si.', 'No.', 'Non sempre.'],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		text: "Che cosa è l'angolo d'incidenza?",
// 		answers: [
// 			"È l'angolo compreso tra la corda alare e la di rezione del vento relativo o traiettoria di volo.",
// 			"È l'angolo compreso tra la corda alare e il piano orizzontale passante per il centro di pressione.",
// 			"È l'angolo compreso tra la corda alare e la di rezione del vento meteorologico quando l'ala è in movimento."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '2079',
// 		section: 'AERODINAMICA',
// 		text: "L'assetto di un profilo rappresenta un'en tità angolare ben distinta dall'incidenza. Esso è per definizione:",
// 		answers: [
// 			"l'angolo compreso tra la corda alare ed il piano orizzontale.",
// 			"l'angolo compreso tra la corda alare e la dire zione del vento relativo o traiettoria di volo.",
// 			"l'angolo compreso tra la direzione del vento re lativo o traiettoria di volo ed il piano orizzon tale."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		text: "Perché nella formula della resistenza R= 1/2 Cr S V² non compare l'angolo d'incidenza al cui variare varia la resistenza stessa?",
// 		answers: [
// 			"Perché al variare dell'incidenza varia la sola su perficie proiettata.",
// 			"Perché un'altra formula lega incidenza e resi stenza aerodinamica.",
// 			"Perché al variare dell'incidenza varia il Cr."
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '2083',
// 		section: 'AERODINAMICA',
// 		text: "Per aumentare la portanza di un certo pro filo alare è sufficiente aumentare l'angolo d'inci denza?",
// 		answers: [
// 			'Si, senza alcuna limitazione.',
// 			'Si, da zero a venti gradi.',
// 			'Si, ma entro ben precisi limiti.'
...
// 		id: '2084',
// 		section: 'AERODINAMICA',
// 		text: "Variando l'incidenza di un profilo la por tanza:",
// 		answers: ['varia.', 'non varia.', 'varia mentre la resistenza non varia.'],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		answers: [
// 			"Perché al variare dell'incidenza varia la sola su perficie proiettata.",
// 			"Perché un'altra formula lega incidenza e por tanza.",
// 			"Perché al variare dell'incidenza varia il CD."
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '2086',
// 		section: 'AERODINAMICA',
// 		text: 'Come può in volo il pilota variare la por tanza?',
// 		answers: [
// 			'Diminuendo la resistenza aerodinamica.',
// 			"Variando l'angolo d'incidenza entro certi limiti.",
// 			'Mantenendo lo stesso angolo di assetto.'
...
// 		id: '2087',
// 		section: 'AERODINAMICA',
// 		text: 'Il peso del sistema ala-pilota, cui durante il volo si oppone la risultante aerodinamica, è una forza verticale diretta verso il basso, che si scom pone in:',
// 		answers: [
// 			'trazione nella direzione della traiettoria di volo e peso apparente perpendicolarmente alla stessa.',
// 			'trazione perpendicolarmente alla traiettoria di volo e peso apparente nella direzione della stessa.',
// 			'trazione nella direzione della traiettoria di volo e peso apparente in direzione opposta.'
...
// 		id: '2089',
// 		section: 'AERODINAMICA',
// 		text: "Come si chiama l'energia sfruttata dal si stema ala pilota in volo planato?",
// 		answers: ['Energia termica.', 'Energia endotermica.', 'Energia potenziale.'],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'Che cosa è la trazione nel volo planato?',
// 		answers: [
// 			'È una forza ed è la componente del peso orien tata nella direzione della traiettoria di volo.',
// 			'È una forza ed è la componente del peso orien tata perpendicolarmente alla traiettoria di volo.',
// 			'È una forza che varia al variare della pendenza della traiettoria, ma è indipendente dal peso.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '2091',
// 		section: 'AERODINAMICA',
// 		text: "Com'è possibile variare il valore della tra zione in volo?",
// 		answers: [
// 			'Non può essere variato.',
// 			'Variando la pendenza della traiettoria di volo.',
// 			'Variando la sola resistenza aerodinamica.'
...
// 		text: "In virata come variano il peso apparente e la superficie proiettata dell'ala?",
// 		answers: [
// 			"Aumentano entrambi, il peso apparente a causa dell'accelerazione centripeta, la superfi cie proiettata per motivi geometrici.",
// 			"Aumenta il peso apparente a causa dell'accele razione centrifuga e diminuisce la superficie proiettata per motivi geometrici.",
// 			'Non variano né il peso apparente né la super ficie proiettata.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		text: "Che cosa s'intende per fattore di carico?",
// 		answers: [
// 			"Un fattore numerico capace di indicare quante volte il peso del sistema ala-pilota varia per ef fetto dell'accelerazione centrifuga in virata o di altre accelerazioni positive o negative durante le manovre.",
// 			'Un fattore numerico capace di indicare di quante volte aumenta la resistenza aerodina mica in virata per effetto della forza centrifuga.',
// 			'Un fattore numerico caratteristico di un tipo di deltaplano o parapendio collegato alla robu stezza delle sue strutture verificata in tutti i tipi di manovra in volo.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		answers: [
// 			'È il punto di applicazione della forza peso.',
// 			"È il punto in cui sempre s'incrociano i tre assi dell'ala, quello di beccheggio di rollio e d'imbar data.",
// 			"È il punto di applicazione della risultante di tutte le forze aerodinamiche generate dall'ala in movimento nell'aria."
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '2103',
// 		section: 'AERODINAMICA',
// 		text: "Come varia mediamente la posizione del centro di pressione al variare dell'incidenza su pro fili autostabili?",
// 		answers: [
// 			"Diminuendo l'incidenza il centro di pressione avanza ed aumentando l'incidenza il centro di pressione arretra.",
// 			"Diminuendo l'incidenza il centro di pressione arretra ed aumentando l'incidenza il centro di pressione avanza.",
// 			"Al variare dell'incidenza il centro di pressione non si sposta."
...
// 		answers: [
// 			'Il punto di applicazione della forza peso.',
// 			'Il punto di applicazione della risultante aerodi namica.',
// 			"Il punto di intersezione degli assi dell'apparec chio."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		text: 'La posizione del baricentro si sposta',
// 		answers: [
// 			"solo a seguito di manovre attorno all'asse tra sversale.",
// 			"solo a seguito di manovre attorno all'asse lon gitudinale.",
// 			"sia a seguito di manovre attorno all'asse tra sversale che longitudinale."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: "L'efficienza aerodinamica è:",
// 		answers: [
// 			'il rapporto tra la sua superficie ed il peso tra sportato.',
// 			'il rapporto tra il peso trasportato e la sua velo cità massima.',
// 			'il rapporto tra Cp e Cr.'
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		answers: [
// 			'il rapporto tra la velocità orizzontale e quella verticale.',
// 			'il rapporto tra la velocità verticale e quella oriz zontale.',
// 			'il rapporto tra superficie e peso.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '2110',
// 		section: 'AERODINAMICA',
// 		text: "Il rapporto tra portanza e resistenza gene rate da un'ala a un certo regime di volo, ne rap presenta l'efficienza e varia:",
// 		answers: [
// 			"al variare dell'angolo d'incidenza.",
// 			'al variare della superficie alare.',
// 			'al variare del carico alare.'
...
// 		text: "L'efficienza massima di un parapendio è uguale a 8. Che cosa significa?",
// 		answers: [
// 			'In aria calma può essere percorso 1 km per dendo 800 m di quota.',
// 			'Il rapporto tra apertura alare e corda alare è pari a 8.',
// 			'In aria calma possono essere percorsi 8 km perdendo 1000 m di quota.'
// 		],
// 		correct_answer_index: 2
...
// 		text: "L'efficienza massima varia al variare del peso del pilota?",
// 		answers: [
// 			"Si, anche se l'ala al variare del peso non si de forma.",
// 			"No, purché al variare del peso l'ala non si de formi e l'aria sia calma.",
// 			"No, anche se l'ala al variare del peso si de forma."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '2114',
// 		section: 'AERODINAMICA',
// 		text: "Volando in aria calma due piloti di peso diverso utilizzano lo stesso deltaplano o parapen dio. Che risultati ottengono volando al medesimo regime di volo, se l'ala non si deforma al variare del carico?",
// 		answers: [
// 			'Percorrono la stessa distanza, ma in tempi di versi.',
// 			'Percorrono distanze diverse, ma impiegano uguali tempi.',
// 			"Percorrono distanze diverse ed in tempi diversi anche se l'ala non si deforma in funzione del peso."
// 		],
// 		correct_answer_index: 0
...
// 		id: '2115',
// 		section: 'AERODINAMICA',
// 		text: "Volando in aria calma il peso del pilota, se l'ala non si deforma al variare del carico, influen zerà:",
// 		answers: [
// 			'la sola efficienza aerodinamica.',
// 			"l'efficienza aerodinamica e la velocità all'aria, ma non il tasso di caduta.",
// 			"la velocità all'aria ed il tasso di caduta, ma non l'efficienza aerodinamica."
...
// 		id: '2118',
// 		section: 'AERODINAMICA',
// 		text: "E' possibile che un deltaplano o un para pendio volino stabilmente su una traiettoria oriz zontale in condizioni di aria calma?",
// 		answers: [
// 			'Si, se il loro profilo è molto sofisticato.',
// 			'No, perché ciò significherebbe in sostanza che è stato azzerato il valore della resistenza aero dinamica.',
// 			'Si, avendo un basso carico alare.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '2119',
// 		section: 'AERODINAMICA',
// 		text: 'Traiettorie orizzontali stabili sono realizza bili con deltaplano e parapendio:',
// 		answers: [
// 			'solo rispetto al terreno in condizioni di vento in coda sostenuto.',
// 			'solo rispetto al terreno in condizioni di ascen denza.',
// 			"anche rispetto all'aria in condizioni di ascen denza."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		answers: [
// 			"indica i valori di velocità al suolo al variare dell'incidenza.",
// 			"indica i valori dei coefficienti di portanza e re sistenza al variare dell'angolo di assetto.",
// 			"indica i valori dei coefficienti di portanza e re sistenza al variare dell'angolo d'incidenza."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '2121',
// 		section: 'AERODINAMICA',
// 		text: "Che cosa è la polare delle velocità o odo grafa di un'ala?",
// 		answers: [
// 			"È un grafico sul quale sono riportati i valori delle velocità orizzontali e delle velocità verti cali dell'ala al variare dell'angolo d'incidenza.",
// 			"È un grafico sul quale sono riportati i valori della portanza e della resistenza al variare dell'angolo d'incidenza.",
// 			"È un grafico sul quale sono riportati i valori della trazione e della resistenza al variare dell'angolo d'incidenza."
// 		],
// 		correct_answer_index: 0
...
// 		text: "Se l'ala non si deforma, al variare del peso del pilota la polare delle velocità:",
// 		answers: [
// 			'si modifica e non si sposta rispetto agli assi car tesiani.',
// 			'non si modifica e non si sposta rispetto agli assi cartesiani.',
// 			'si sposta rispetto agli assi cartesiani.'
// 		],
// 		correct_answer_index: 2
...
// 		id: '2123',
// 		section: 'AERODINAMICA',
// 		text: "Quali valori si possono ricavare dalla po lare delle velocità di un'ala?",
// 		answers: [
// 			"Quelli della portanza al variare dell'incidenza.",
// 			"Quelli della resistenza al variare dell'incidenza.",
// 			"Quelli delle velocità orizzontali e verticali ai vari angoli d'incidenza."
...
// 		id: '2124',
// 		section: 'AERODINAMICA',
// 		text: "Sulla polare delle velocità di un'ala nor malmente il minimo tasso di caduta si realizza vo lando:",
// 		answers: [
// 			"all'incidenza alla quale corrisponde il minimo valore della resistenza.",
// 			"all'incidenza alla quale corrisponde la massima efficienza in aria calma.",
// 			"ad un'incidenza maggiore di quella cui corri sponde la massima efficienza in aria calma."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '2125',
// 		section: 'AERODINAMICA',
// 		text: "Sulla polare delle velocità di un'ala nor malmente la massima velocità orizzontale si rea lizza volando:",
// 		answers: [
// 			"al valore d'incidenza cui corrisponde una resi stenza maggiore a quella che si ottiene alla massima efficienza aria.",
// 			"al valore d'incidenza cui corrisponde il miglior rapporto superficie proiettata / allungamento.",
// 			"al valore d'incidenza massimo."
// 		],
// 		correct_answer_index: 0
...
// 		id: '2126',
// 		section: 'AERODINAMICA',
// 		text: "Sulla polare delle velocità di un'ala nor malmente la massima efficienza in aria calma si realizza volando:",
// 		answers: [
// 			"con l'angolo d'incidenza cui corrisponde il va lore massimo del rapporto tra resistenza e por tanza.",
// 			"con l'angolo d'incidenza cui corrisponde il va lore massimo del rapporto tra portanza e resi stenza.",
// 			"con l'angolo d'incidenza cui corrisponde il va lore massimo del rapporto tra portanza e peso."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '2127',
// 		section: 'AERODINAMICA',
// 		text: "In condizioni di ascendenza l'efficienza massima al suolo aumenta rispetto a quella che si otterrebbe in aria calma. Adeguando la polare delle velocità di un'ala a queste condizioni si vede che i migliori risultati si realizzano comunque vo lando:",
// 		answers: [
// 			"a velocità all'aria maggiore di quelle utilizzate in condizioni di aria calma.",
// 			"a velocità all'aria minore di quelle utilizzate in condizioni di aria calma.",
// 			"alla medesima velocità all'aria che si utilizze rebbe in condizioni di aria calma."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '2128',
// 		section: 'AERODINAMICA',
// 		text: "In condizioni di discendenza l'efficienza massima al suolo diminuisce rispetto a quella che si otterrebbe in aria calma. Adeguando la polare delle velocità di un'ala a queste condizioni si vede che i migliori risultati comunque si realizzano vo lando:",
// 		answers: [
// 			"a velocità all'aria maggiori di quelle utilizzate in aria calma.",
// 			"a velocità all'aria minori di quelle utilizzate in aria calma.",
// 			"alla medesima velocità all'aria che si utilizze rebbe in condizioni di aria calma."
...
// 		id: '2129',
// 		section: 'AERODINAMICA',
// 		text: 'Con vento a favore la massima efficienza al suolo è maggiore di quella ottenibile in aria calma. Sulla polare delle velocità si vede che i mi gliori risultati si realizzano comunque volando:',
// 		answers: [
// 			"ad incidenza maggiore di quella che si utilizze rebbe per ottenere la massima efficienza in aria calma (velocità all'aria minore).",
// 			"ad incidenza minore di quella che si utilizze rebbe per ottenere la massima efficienza in aria calma (velocità all'aria maggiore).",
// 			"all'incidenza che si utilizzerebbe per ottenere la massima efficienza in aria calma."
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '2130',
// 		section: 'AERODINAMICA',
// 		text: 'Con vento contrario la massima efficienza al suolo è minore di quella ottenibile in aria calma. Sulla polare delle velocità si vede che i migliori ri sultati si realizzano comunque volando:',
// 		answers: [
// 			"all'incidenza che si utilizzerebbe per ottenere la massima efficienza in aria calma.",
// 			"ad incidenza maggiore di quella che si utilizze rebbe per ottenere la massima efficienza in aria calma (velocità all'aria minore).",
// 			"ad incidenza minore di quella che si utilizze rebbe per ottenere la massima efficienza in aria calma (velocità all'aria maggiore)."
...
// 		text: 'In condizioni di vento contrario, usando la stessa ala, il pilota più pesante:',
// 		answers: [
// 			"volerà con un'efficienza massima al suolo mi nore di quella realizzata dal pilota più leggero.",
// 			"volerà con un'efficienza al suolo identica a quella realizzata dal pilota più leggero.",
// 			"volerà con un'efficienza massima al suolo mag giore di quella realizzata dal pilota più leggero."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 			"volerà con un'efficienza massima al suolo mi nore di quella realizzata dal pilota più leggero.",
// 			"volerà con un'efficienza massima al suolo mag giore di quella realizzata dal pilota più leggero.",
// 			"volerà con un'efficienza massima al suolo iden tica a quella realizzata dal pilota più leggero."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '2134',
// 		section: 'AERODINAMICA',
// 		text: 'In condizioni aerologiche sfavorevoli, quali vento contrario e discendenza, volando con la me desima ala è:',
// 		answers: [
// 			'sfavorito il pilota più pesante.',
// 			'sfavorito il pilota più leggero.',
// 			'non ci sono differenze.'
...
// 		text: 'Che cosa è lo stallo?',
// 		answers: [
// 			"una condizione di volo in cui si verifica il di stacco dei filetti fluidi dall'ala a causa dell'ec cessivo angolo d'incidenza.",
// 			"È una condizione di volo in cui si verifica un calo netto della portanza a causa di una brusca diminuzione dell'angolo d'incidenza.",
// 			"È una condizione di volo in cui si verifica un brusco aumento della resistenza dovuto all'ec cessiva velocità."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		answers: [
// 			"solo a bassa velocità indipendentemente dall'angolo d'incidenza.",
// 			'solo a bassa velocità con incidenza oltre il va lore critico.',
// 			'a qualsiasi velocità con incidenza oltre il valore critico.'
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '2139',
// 		section: 'AERODINAMICA',
// 		text: "E' possibile con il deltaplano e il parapen dio andare in stallo ad alta velocità?",
// 		answers: [
// 			'No.',
// 			'Solo in virata.',
// 			"Si, se si raggiunge e si supera il valore critico dell'angolo di incidenza."
...
// 		id: '2141',
// 		section: 'AERODINAMICA',
// 		text: "Che cosa s'intende per autostabilità di un profilo?",
// 		answers: [
// 			'Una tendenza a cabrare o picchiare a seguito di un qualsiasi intervento del pilota sui co mandi.',
// 			'Una tendenza a picchiare comunque dopo il ve rificarsi di uno stallo accentuato.',
...
// 		id: '2142',
// 		section: 'AERODINAMICA',
// 		text: 'Perché deltaplano e parapendio sono macchine considerate autostabili?',
// 		answers: [
// 			'Perché reagiscono alle sollecitazioni aerodina miche rispetto agli assi di rotazione tendendo a ritornare automaticamente in condizioni di equilibrio.',
// 			"Solo perché a un movimento rispetto all'asse longitudinale reagiscono con una tendenza a ri tornare automaticamente in condizioni di equi librio.",
// 			"Solo perché a un movimento rispetto all'asse verticale reagiscono con una tendenza a ritor nare automaticamente in condizioni di equili brio."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '2143',
// 		section: 'AERODINAMICA',
// 		text: 'Che cosa succede al sistema ala - pilota se il suo baricentro viene abbassato rispetto al centro di pressione?',
// 		answers: [
...
// 		id: '2144',
// 		section: 'AERODINAMICA',
// 		text: 'La posizione bassa del baricentro del pa rapendio comporta entro certi limiti:',
// 		answers: [
...
// 		id: '2145',
// 		section: 'AERODINAMICA',
// 		text: 'La posizione bassa del baricentro del pa rapendio comporta:',
// 		answers: [
...
// 		id: '2146',
// 		section: 'AERODINAMICA',
// 		text: "Lo svergolamento di un'ala, contribuisce alla stabilità in volo?",
// 		answers: ['No.', 'Si.', 'Si, se lo svergolamento è adeguatamente cal colato.'],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '2147',
// 		section: 'AERODINAMICA',
// 		text: 'Volando in prossimità del terreno il delta plano acquista prestazioni. Ciò è dovuto:',
// 		answers: [
...
// 		id: '2148',
// 		section: 'AERODINAMICA',
// 		text: "A che cosa è dovuto principalmente l'ef fetto suolo?",
// 		answers: [
// 			"Solo ad una compressione dell'aria al suolo do vuta all'avvicinarsi dell'ala ad esso.",
// 			"Ad una riduzione della resistenza indotta all'ap prossimarsi dell'ala al suolo.",
...
// 		id: '2149',
// 		section: 'AERODINAMICA',
// 		text: 'Che cosa s\'intende per "configurazione inusuale"?',
// 		answers: [
// 			'Una situazione di volo in condizioni ambientali e meteorologiche estreme.',
// 			"Una situazione di volo con un numero di pas seggeri eccedente quello previsto dal manuale d'impiego.",
// 			'Una variazione di geometria e/o un comporta mento anomalo del mezzo normalmente non indotti dal pilota direttamente, come tumbling, chiusure, autorotazioni positive e negative, stalli paracadutali ecc.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '2150',
// 		section: 'AERODINAMICA',
// 		text: 'Quale parametro di volo può provocare una "configurazione inusuale"?',
// 		answers: [
...
// 		id: '3001',
// 		section: 'PRONTO SOCCORSO',
// 		text: "Quale comportamento è auspicabile ap pena effettuato un soccorso d'emergenza?",
// 		answers: [
...
// 			'Una volta chiamate si attende che giungano le autorità di polizia e si lascia a esse ogni incom benza.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '3002',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Qual è, tra questi, il modo migliore per ac compagnare un infortunato con una lesione leg gera in grado di camminare?',
// 		answers: [
...
// 		id: '3003',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Come comportarsi alla presenza di un in fortunato di cui si sospettano lesioni interne di en tità sconosciuta?',
// 		answers: [
...
// 			'Non muoverlo assolutamente e non consentire che egli stesso si muova, provvedere immedia tamente a chiamare personale e mezzi di soc corso qualificati e attrezzati (eliambulanza, am bulanza, etc.).',
// 			"Cercare di metterlo in piedi, se la cosa risulta impossibile e se l'infortunato si lamenta chia mare idonei mezzi di soccorso."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '3004',
// 		section: 'PRONTO SOCCORSO',
// 		text: "Se, essendo l'unico presente, vi capita di dover soccorrere un traumatizzato, come dovete comportarvi?",
// 		answers: [
...
// 		id: '3005',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Come intervenire su un infortunato che presenta una copiosa perdita di sangue da una fe rita?',
// 		answers: [
// 			'Lasciare uscire più sangue possibile onde la vare la ferita.',
...
// 		id: '3006',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Come si deve intervenire soccorrendo un infortunato che presenta solo una ferita?',
// 		answers: [
// 			'Cercare di aiutarlo a mettersi in piedi.',
// 			"Lasciare la ferita scoperta dopo averla oppor tunamente tamponata, sino all'arrivo di idoneo soccorso.",
// 			"Tamponare la ferita con ciò che è possibile, cercando di lasciare coperta la ferita sino all'ar rivo d'idoneo soccorso."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '3007',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Come si deve intervenire in caso di forma lieve di fuoriuscita di sangue dal naso (epistassi)?',
// 		answers: [
// 			'Far reclinar la testa in avanti favorendo il dre naggio di sangue e muco.',
...
// 		id: '3008',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Come si deve intervenire alla presenza di una persona colpita da soffocamento?',
// 		answers: [
// 			"Lasciare che l'infortunato riprenda a respirare dopo averlo adagiato supino.",
// 			"Rimuovere le più evidenti cause di soffoca mento, accertare che il soffocamento non sia dovuto all'ingestione di vomito e che la lingua non sia motivo d'impedimento alla ventilazione.",
// 			"Tentare la respirazione artificiale prima di tutto, premendo sull'addome dell'infortunato in ma niera decisa e ritmica.."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '3009',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Come intervenire alla presenza di una per sona in stato di shock?',
// 		answers: [
// 			"Lasciarla tranquilla e alleggerirgli l'abbiglia mento per evitare che sudi.",
// 			'Somministrargli liquori o caffè per farla ripren dere.',
...
// 		id: '3010',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Se in un infortunato si sospetta una frat tura, come dobbiamo comportarci?',
// 		answers: [
...
// 			'Immobilizzare il traumatizzato e solo se trattasi di frattura a uno degli arti cercare di steccarlo con una "doccia" più idonea possibile, provve dendo comunque ad allertare al più presto ido nei mezzi di soccorso.',
// 			'Fasciare strettamente la parte del corpo in cui si trova la sospetta frattura in attesa di even tuali idonei mezzi di soccorso.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		id: '3012',
// 		section: 'PRONTO SOCCORSO',
// 		text: "Come s'interviene nel caso che una per sona presenti un trauma all'addome?",
// 		answers: [
// 			'Si provvede a chiamare idonei mezzi di soc corso, mettendola in piedi per alleviarle il do lore.',
// 			"Si provvede a chiamare idonei mezzi di soc corso, evitando di muoverla e di comprimerle l'addome.",
// 			"Si provvede a chiamare idonei mezzi di soc corso, nel frattempo le si praticano massaggi all'addome."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		answers: [
// 			'avvicinarsi al più presto e prestarle soccorso.',
// 			"rimanere a distanza di sicurezza dando imme diatamente l'allarme.",
// 			'distaccarla immediatamente dalla sorgente elettrica servendosi ad esempio di un bastone di legno, che è uno strumento isolante.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '3015',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Come intervenire in soccorso di un sog getto che presenti una distorsione al piede?',
// 		answers: [
// 			'Farlo camminare subito per ripristinargli la cir colazione.',
// 			'Immobilizzare la parte lesa con ovatta ed even tuale fascia elastica.',
// 			"Trazionare l'arto infortunato cercando di ricom porre la distorsione."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		text: 'Come si riconosce una spalla lussata?',
// 		answers: [
// 			"Da un abbassamento dell'arto con infossa mento all'altezza dell'articolazione.",
// 			"Da un improvviso gonfiore in corrispondenza dell'articolazione.",
// 			'Dal fatto che braccio e avambraccio risultano privi di articolazione.'
// 		],
// 		correct_answer_index: 0
...
// 			'Si mantiene pulita e detersa la parte ustionata sino al momento in cui sono possibili interventi specialistici qualificati.',
// 			"Non si tocca assolutamente la parte ustionata anche se è sporca trasportando l'infortunato dal medico più vicino.",
// 			'Si pone sulla parte ustionata un qualsiasi un guento disponibile.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		text: "Come s'interviene per soccorrere persone che abbiano perso conoscenza?",
// 		answers: [
// 			'Si lasciano o si adagiano semplicemente in po sizione prona.',
// 			'Si dispongono su un fianco sollevando un brac cio e una gamba per evitare che il vomito ostruisca le vie respiratorie.',
// 			'Si bagna loro la fronte con acqua fredda.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		text: "Come s'interviene su una persona svenuta a seguito di trauma?",
// 		answers: [
// 			'Si prova a rianimarla energicamente scuoten dola dopo aver chiamato idonei mezzi di soc corso.',
// 			'Si tiene sotto monitoraggio il battito cardiaco e la frequenza respiratoria, chiamando con ur genza idonei mezzi di soccorso.',
// 			'Si adagia in posizione supina, le si pratica la respirazione, si chiamano se necessario idonei mezzi di soccorso.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '3020',
// 		section: 'PRONTO SOCCORSO',
// 		text: 'Qual è il rimedio migliore in caso di princi pio di assideramento di una parte del corpo?',
// 		answers: [
// 			'Fare ingerire al paziente bevande alcoliche.',
// 			'Fare muovere la parte colpita in modo da pro vocare circolazione sanguigna.',
// 			'Tenere la parte colpita al caldo coprendola e facendo ingerire al paziente bevande calde.'
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '4001',
// 		section: 'FISIOPATOLOGIA DEL VOLO',
// 		text: "Come varia la pressione parziale dell'os sigeno a livello polmonare, al variare dell'altitu dine?",
// 		answers: [
// 			"Diminuisce all'aumentare dell'altitudine.",
// 			"Diminuisce all'aumentare dell'altitudine, ma non scende mai sotto valori di guardia.",
// 			"Aumenta all'aumentare dell'altitudine."
...
// 		id: '4002',
// 		section: 'FISIOPATOLOGIA DEL VOLO',
// 		text: "Ad elevate altitudini nell'organismo umano si instaura una situazione alterata, pro dotta dalla ridotta pressione di ossigeno. Essa prende il nome di:",
// 		answers: ['ipotermia.', 'ipossia.', 'ipotensione.'],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		text: "Che cosa è l'ipossia?",
// 		answers: [
// 			"È lo stato in cui l'organismo viene a trovarsi a causa dell'insufficiente pressione sangui gna dovuta alla quota.",
// 			"È lo stato in cui l'organismo viene a trovarsi a causa dell'insufficiente temperatura corpo rea dovuta alla quota.",
// 			"È lo stato in cui l'organismo viene a trovarsi a causa dell'insufficiente pressione dell'ossi geno a livello degli alveoli polmonari dovuta alla quota."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 			"Diminuzione dell'efficienza mentale, nausea, euforia, aumento del ritmo di ventilazione polmonare.",
// 			'Vasodilatazione periferica, secchezza delle fauci, rigidità muscolare, diminuzione del ritmo di ventilazione polmonare.',
// 			'Diminuzione della pressione arteriosa, ische mia periferica, paralisi dei centri respiratori.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '4005',
// 		section: 'FISIOPATOLOGIA DEL VOLO',
// 		text: 'La decompressione da alta quota può dar luogo a liberazione di bolle gassose nel san gue, detti emboli. Qual è la condizione in cui questo pericoloso fenomeno può verificarsi con maggiore facilità?',
// 		answers: [
// 			'Lenta ascensione oltre i 7000 metri.',
// 			'Rapida ascensione a 7000 metri ed oltre.',
// 			'Permanenza ad alta quota dopo lungo pe riodo di ambientamento.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '4006',
// 		section: 'FISIOPATOLOGIA DEL VOLO',
// 		text: 'Durante il volo il corpo umano è sotto posto a vari tipi di accelerazione. Quali sono me glio sopportate tra quelle positive (testa-piedi) e quelle negative (piedi-testa)?',
// 		answers: ['Entrambe in uguale misura.', 'Quelle negative.', 'Quelle positive.'],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '4008',
// 		section: 'FISIOPATOLOGIA DEL VOLO',
// 		text: 'Le accelerazioni negative (piedi-testa) corrispondono a una diminuzione dei "G" o me glio a una diminuzione fittizia della accelera zione di gravità. Quando si possono manifestare in volo?',
// 		answers: [
...
// 		id: '4009',
// 		section: 'FISIOPATOLOGIA DEL VOLO',
// 		text: 'Quando sussiste in volo il rischio che il pilota soffra di un oscuramento della vista a se guito di manovre che inducono forti accelera zioni?',
// 		answers: [
// 			'Quando le accelerazioni indotte sono del tipo positivo (testa-piedi) e superano i 4 "G" per un tempo superiore a 4 secondi.',
// 			'Quando comunque sono del tipo negativo (piedi-testa).',
// 			'Quando si passa da accelerazioni positive ad accelerazioni negative senza soluzione di continuità in meno di 4 secondi.'
...
// 		id: '4010',
// 		section: 'FISIOPATOLOGIA DEL VOLO',
// 		text: "Considerate le caratteristiche fisiologi che dell'uomo, è possibile eseguire corretta mente un volo in nube, facendo affidamento sul solo senso dell'equilibrio?",
// 		answers: ['No.', 'Si.', "Si, se l'equilibrio è affinato da adeguato ad destramento."],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5001',
...
// 		text: "Che cosa è l'atmosfera?",
// 		answers: [
// 			'È la massa gassosa che sovrasta la superficie terrestre e la cui altezza è praticamente illimi tata.',
// 			'È la massa gassosa che sovrasta la superficie terrestre e la cui altezza è 12 km.',
// 			'È la massa gassosa di altezza ben definita che sovrasta la superficie terrestre la cui parte in feriore si definisce troposfera.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 			"È la porzione inferiore dell'atmosfera compresa tra la superficie terrestre e la quota alla quale la pressione atmosferica è praticamente nulla.",
// 			"È la porzione inferiore dell'atmosfera compresa tra la superficie terrestre e la quota alla quale l'umidità dell'aria è uguale a zero.",
// 			"È la porzione inferiore dell'atmosfera compresa tra la superficie terrestre e lo strato, detto tro popausa, all'interno del quale il gradiente ter mico verticale dell'aria è praticamente nullo."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5003',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'I fenomeni meteorologici (meteore) si ve rificano normalmente:',
// 		answers: [
// 			"all'interno della porzione di atmosfera terrestre detta troposfera.",
// 			"all'interno dell'intera atmosfera e sino al suo li mite superiore.",
// 			'solo negli strati bassi della troposfera.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '5004',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'La quota della tropopausa, intesa come li mite superiore della troposfera:',
// 		answers: [
// 			'è ben determinata, non è variabile e il suo va lore è di 12 km.',
// 			"è variabile in funzione delle stagioni e della la titudine, il suo valore oscilla mediamente tra 8 km in corrispondenza dei poli e 16 km in corri spondenza dell'equatore.",
// 			"è variabile solo in funzione della latitudine, il suo valore è 8 km ai poli e 16 km all'equatore."
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '5005',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "L'aria è una miscela di gas formata preva lentemente da:",
// 		answers: [
// 			'ossigeno e gas rari.',
// 			'azoto, ossigeno, vapore acqueo e gas rari.',
// 			'azoto, ossigeno e vapore acqueo condensato.'
...
// 		id: '5007',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Il vapore acqueo è un gas invisibile conte nuto nell'aria in percentuali variabili?",
// 		answers: [
// 			'Si.',
// 			'No, è un gas visibile.',
// 			'No, non è un gas ma acqua liquida in minuscole gocce quindi pur sempre visibile.'
...
// 		id: '5008',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'In natura esiste normalmente aria total mente priva di vapore acqueo, cioè assolutamente secca?',
// 		answers: ['No.', 'Si.', 'Si, in corrispondenza di regioni desertiche.'],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		text: "Per umidità assoluta s'intende:",
// 		answers: [
// 			"la quantità in grammi di vapore acqueo conte nuta in un metro cubo d'aria.",
// 			"la quantità in volume di vapore acqueo conte nuta in un metro cubo d'aria.",
// 			"la quantità in grammi di vapore acqueo neces saria a saturare un metro cubo d'aria."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 			"la quantità in grammi di vapore acqueo conte nuta in un metro cubo d'aria.",
// 			"la quantità in volume di vapore acqueo conte nuta in un metro cubo d'aria.",
// 			"la quantità in grammi di vapore acqueo conte nuta in un chilogrammo d'aria."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		answers: [
// 			"la quantità in volume di vapore acqueo conte nuta in un metro cubo d'aria.",
// 			"la quantità in volume di vapore acqueo conte nuta in un chilogrammo d'aria.",
// 			"il rapporto esistente tra il contenuto attuale di vapore acqueo dell'aria ed il contenuto di va pore acqueo necessario alla saturazione (mas simo contenuto di vapore acqueo possibile ai valori attuali di pressione e temperatura dell'aria)."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5012',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Come varia l'umidità relativa dell'aria ab bassandone la sola temperatura?",
// 		answers: [
// 			"L'umidità relativa aumenta sino a raggiungere anche il valore del 100%.",
// 			"L'umidità relativa diminuisce.",
// 			"L'umidità relativa non varia al variare della tem peratura se la pressione rimane costante."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		answers: [
// 			"L'umidità relativa diminuisce.",
// 			"L'umidità relativa aumenta anche sino a rag giungere il valore del 100%.",
// 			"L'umidità relativa non varia al variare della pressione se la temperatura rimane costante."
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		text: 'Che cosa è la temperatura di rugiada?',
// 		answers: [
// 			"La temperatura alla quale l'aria diverrebbe sa tura se raffreddata senza subire variazioni di pressione.",
// 			"La temperatura alla quale l'aria diverrebbe sa tura se riscaldata senza subire variazioni di pressione.",
// 			'La temperatura alla quale si otterrebbe la satu razione aumentando la pressione di un millibar o hectopascal.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5015',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Che cosa avviene quando per qualche mo tivo l'umidità relativa dell'aria raggiunge il valore del 100%?",
// 		answers: [
// 			"L'aria in questione diviene satura e in essa può aver luogo il processo di condensazione del va pore acqueo.",
// 			"L'aria in questione diviene satura e non può quindi aver luogo il processo di condensazione del vapore acqueo.",
// 			"L'aria in questione diviene satura e in essa può aver luogo il processo di condensazione del va pore acqueo solo qualora aumenti contempo raneamente la temperatura."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5016',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Perché all'interno di una massa d'aria av venga il processo di condensazione del vapore ac queo è necessario:",
// 		answers: [
// 			'abbassarne temperatura e pressione contem poraneamente.',
// 			'abbassarne la temperatura qualora la pres sione rimanga costante.',
// 			'abbassarne la pressione qualora la tempera tura rimanga costante.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5017',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Il processo di condensazione del vapore acqueo nell'aria atmosferica determina il passag gio di stato dell'acqua da gas a liquido. E' possibile affermare che tale processo sprigiona energia ter mica (calore latente di condensazione) che è tra smessa all'aria stessa, la cui temperatura varia conseguentemente?",
// 		answers: [
// 			'Si.',
// 			"No, perché i passaggi di stato dell'acqua dallo stato gassoso allo stato liquido e viceversa non sprigionano energia termica.",
// 			"No, perché comunque l'energia termica sprigio nata non altera la temperatura dell'aria."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 			"Si, infatti la temperatura dell'acqua liquida s'in nalza perché l'evaporazione è un processo che libera calore."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		id: '5020',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Generalmente si può affermare che i pro cessi di condensazione e di evaporazione dell'ac qua:",
// 		answers: [
// 			"rispettivamente forniscono e sottraggono ca lore alla massa d'aria interessata.",
// 			"non forniscono né sottraggono calore alla massa d'aria interessata.",
// 			"sono solo in grado di fornire calore alla massa d'aria interessata."
// 		],
// 		correct_answer_index: 0
...
// 		id: '5021',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "È vero che i fenomeni meteorologici sono anche causati dai processi di trasformazione dell'acqua da liquido a vapore o a solido e vice versa per via delle conseguenti cessioni o sottra zioni di energia termica alle masse d'aria?",
// 		answers: [
// 			'No, essi non hanno nulla a che vedere con quanto sopra.',
// 			'No, essi sono esclusivamente determinati dai processi di condensazione del vapore acqueo.',
// 			'Si.'
...
// 		text: 'Le nubi, così come il fumo di una pentola in cui vi è acqua in ebollizione, sono costituite da vapore acqueo?',
// 		answers: [
// 			'No, ma da aerosol o piccolissime gocce di ac qua allo stato liquido.',
// 			'Si, perché costituite da aerosol che sono mole cole gassose molto grandi.',
// 			'Si, perché in determinate condizioni anche il vapore acqueo è un gas visibile.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '5024',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Lo strumento per misurare la pressione at mosferica è:',
// 		answers: ["l'anemometro.", 'il pressostato.', 'il barometro.'],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5025',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Salendo in quota il valore della pressione atmosferica diminuisce, infatti diminuisce il peso della colonna d'aria che insiste sull'unità di super ficie. Tale diminuzione prende il nome di:",
// 		answers: [
// 			'gradiente barico orizzontale.',
// 			'gradiente barico verticale.',
// 			'gradiente termico verticale.'
...
// 		id: '5027',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "In atmosfera standard, quasi mai esi stente in natura perché ideata dall'uomo come ele mento di riferimento, la pressione al livello del mare è:",
// 		answers: [
// 			'1013.2 millibar o hectopascal.',
// 			'760 millibar.',
// 			'variabile secondo la latitudine.'
...
// 		text: 'Che cosa sono le isobare?',
// 		answers: [
// 			'Le linee che uniscono i punti di uguale altitu dine.',
// 			'Le linee che uniscono i punti nei quali la pres sione atmosferica è standard.',
// 			'Le linee che uniscono i punti nei quali esiste uguale pressione atmosferica.'
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '5030',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Il vento cosiddetto di gradiente è normal mente:',
// 		answers: [
// 			"uno spostamento di aria nell'atmosfera da una zona a pressione maggiore ad una zona a pres sione minore.",
// 			"uno spostamento di aria nell'atmosfera da una zona a pressione minore ad una zona a pres sione maggiore.",
// 			"uno spostamento di aria nell'atmosfera dovuto esclusivamente alla presenza di zone della terra con temperature differenti."
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		answers: [
// 			'Solo perché la superficie terrestre è piena di ostacoli che il vento è costretto ad aggirare.',
// 			'Solo perché attorno ad una zona di alta pres sione esistono più zone di bassa pressione.',
// 			'Soprattutto perché esistono forze devianti, quali quella di Coriolis e quella di attrito col ter reno, che non consentono al vento di proce dere in direzione rettilinea.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5032',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Tutti i corpi, i liquidi e i gas in movimento rispetto alla superficie terrestre, dotati di una com ponente di moto parallela ai meridiani, vengono deviati dalla loro traiettoria inizialmente rettilinea. Come si chiama la forza deviante che determina ciò e a che cosa è dovuta?',
// 		answers: [
// 			'Forza di Coriolis, dovuta alla rotazione della Terra attorno al proprio asse.',
// 			'Forza di Coriolis, dovuta alla rivoluzione della Terra attorno al Sole.',
// 			'Forza deviante, dovuta esclusivamente alla presenza degli attriti generati da ogni tipo di moto.'
...
// 		id: '5033',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Nell'emisfero Nord la forza di Coriolis de termina una deviazione del vento, nel suo dirigersi da una zona di alta pressione a una zona di bassa pressione, verso:",
// 		answers: ['sinistra.', 'destra.', 'altre zone adiacenti di alta pressione.'],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5034',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "A seguito dell'intervento delle forze de vianti, il vento nell'emisfero Nord circola attorno ad una zona od area di alta pressione in senso:",
// 		answers: [
// 			"antiorario se osservato dall'alto (es. da un sa tellite).",
// 			"orario se osservato dall'alto (es. da un satel lite).",
// 			'orario se osservato dal basso.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '5035',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "A seguito dell'intervento delle forze de vianti, il vento nell'emisfero Nord circola attorno ad una zona od area di bassa pressione in senso:",
// 		answers: [
// 			'antiorario se osservato dal basso.',
// 			"orario se osservato dall'alto (es. da un satel lite).",
// 			"antiorario se osservato dall'alto (es. da un sa tellite)."
...
// 		text: 'Come sono chiamate le zone o aree di bassa e di alta pressione?',
// 		answers: [
// 			'Aree cicloniche e anticicloniche e indicate ri spettivamente con una H/A (high pressure/alta pressione) e una L/B (low pressure/bassa pres sione) sulle carte meteorologiche.',
// 			'Aree cicloniche e anticicloniche e indicate ri spettivamente con una L/B (low pres sure/bassa pressione) e una H/A (high pres sure/alta pressione) sulle carte meteorologi che.',
// 			'Aree anticicloniche e cicloniche e indicate ri spettivamente con L/B (low pressure/bassa pressione) e una H/A (high pressure/alta pres sione) sulle carte meteorologiche.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5037',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Se su una carta meteorologica si osser vano isobare molto ravvicinate, si può affermare che:',
// 		answers: [
// 			'esiste un gradiente barico orizzontale minimo e il vento sarà sostenuto.',
// 			'esiste un gradiente barico orizzontale elevato e il vento sarà sostenuto.',
// 			'esiste un gradiente barico verticale elevato e il vento sarà sostenuto.'
...
// 		text: "L'osservazione delle isobare sulla carta del tempo ci consente di:",
// 		answers: [
// 			"individuare la direzione e l'intensità del vento in una certa zona oltre ad altri dati meteorolo gici utili alla previsione del tempo.",
// 			'individuare elementi e dati utili solamente alla previsione del tempo inteso come copertura nuvolosa del cielo.',
// 			"individuare solamente il gradiente barico verti cale per un confronto con i parametri dell'at mosfera standard."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5039',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Nella pratica del Volo Libero che cosa s\'in tende comunemente per "vento meteorologico"?',
// 		answers: [
// 			'Il vento generato da fenomeni meteorologici ri levanti quali temporali, forti precipitazioni ecc.',
// 			'Il vento generato da fenomeni microclimatici locali come le brezze di valle o di monte.',
// 			"Il vento di gradiente, prodotto dalla situazione barica attuale rilevabile dalle carte del tempo mediante l'osservazione delle isobare."
// 		],
// 		correct_answer_index: 2
...
// 		id: '5040',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'A quale valore in gradi corrisponde la di rezione di provenienza di un vento da Sud?',
// 		answers: ['135°', '270°', '180°'],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '5042',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Emisfero Nord. Una Bassa Pressione si trova centrata a Nord di un preciso punto della su perficie terrestre. Il vento predominante (meteo rologico) che ci si attende di avere in quel punto proverrà ragionevolmente da:',
// 		answers: ['Nord.', 'Ovest.', 'Est.'],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5043',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Emisfero Nord. Una Bassa Pressione si trova centrata a Est di un preciso punto della su perficie terrestre. Il vento predominante (meteo rologico) che ci si attende di avere in quel punto proverrà ragionevolmente da:',
// 		answers: ['Nord.', 'Sud.', 'Ovest.'],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5044',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Emisfero Nord. Un'area di Alta Pressione si trova centrata a Nord di un preciso punto della superficie terrestre. Il vento predominante (me teorologico) che ci si attende di avere in quel punto proverrà ragionevolmente da:",
// 		answers: ['Ovest.', 'Est.', 'Nord.'],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5045',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Emisfero Nord. Un'area di Alta Pressione si trova centrata a Ovest di un preciso punto della superficie terrestre. Il vento predominante (me teorologico) che ci si attende di avere in quel punto proverrà ragionevolmente da:",
// 		answers: ['Sud.', 'Est.', 'Nord.'],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5046',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Il Sole è la fonte principale di calore ca pace di elevare la temperatura dell'aria. Nella tro posfera l'energia termica è trasmessa dal Sole di rettamente all'aria stessa?",
// 		answers: [
// 			'Si, in gran parte per irraggiamento.',
// 			'Si, totalmente per conduzione.',
// 			'No, in gran parte è trasmessa indirettamente.'
...
// 		id: '5047',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Il processo di trasmissione di energia ter mica secondo il quale il Sole riscalda la troposfera è:',
// 		answers: [
// 			"irraggiamento del suolo, conduzione di calore dal suolo all'aria sovrastante, circolazione con vettiva di aria calda verso l'alto.",
// 			"irraggiamento degli strati bassi dell'atmosfera per riflessione del suolo, circolazione convet tiva di aria calda verso l'alto.",
// 			"conduzione diretta di calore dal sole agli strati bassi dell'atmosfera con successiva circola zione convettiva di aria calda verso l'alto."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5048',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Durante una salita effettuata nella tropo sfera la temperatura dell'aria varia nel modo se guente:",
// 		answers: ['mediamente aumenta.', 'rimane mediamente costante.', 'mediamente diminuisce.'],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '5051',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Se, salendo in quota, si rileva la tempera tura dell'aria ogni 100 m e si riportano i suoi valori su un grafico, si costruisce:",
// 		answers: [
// 			"la curva o diagramma di stato dell'atmosfera di quella località a quell'ora.",
// 			"l'adiabatica secca dell'atmosfera di quella loca lità a quell'ora.",
// 			"l'isoterma di quella località a quell'ora."
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '5052',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Il gradiente termico verticale dell'atmo sfera in una determinata località a una certa ora si ricava:",
// 		answers: [
// 			"dalla curva di stato dell'atmosfera relativa a quella località ed a quell'ora della giornata.",
// 			"dalla carta del tempo relativa a quella località ed a quell'ora della giornata.",
// 			"dal confronto tra adiabatica secca e adiabatica satura relative a quella località ed a quell'ora della giornata."
...
// 		answers: [
// 			"Sollevamento convettivo, perché avviene con scambio di calore con l'aria sovrastante.",
// 			"Sollevamento dinamico, perché avviene con una variazione molecolare dell'aria che si sol leva.",
// 			"Sollevamento adiabatico, perché avviene in pratica senza scambio di calore con l'aria circo stante."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5054',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "In pratica l'aria che si solleva adiabatica mente, senza condensazione del vapore acqueo, perde:",
// 		answers: [
// 			'6.5°C di temperatura ogni 1000 m.',
// 			'1°C di temperatura ogni 100 m.',
// 			'valori di temperatura in funzione del gradiente termico verticale di quel giorno.'
...
// 		id: '5055',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Il calo di temperatura dell'aria, che si sol leva adiabaticamente di un certo valore di quota senza condensazione del vapore acqueo, si chiama:",
// 		answers: [
// 			"gradiente termico verticale e dipende dall'ora e dalla località in cui il fenomeno si verifica.",
// 			"gradiente adiabatico secco (o gradiente ter mico dell'adiabatica secca) e dipende principal mente dall'ora e dalla località in cui il fenomeno si verifica.",
// 			"gradiente adiabatico secco (o gradiente ter mico dell'adiabatica secca) e si può affermare con buona approssimazione che non dipende dall'ora e dalla località in cui il fenomeno si ve rifica."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5056',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "L'aria che si solleva adiabaticamente con tiene una certa quantità di vapore acqueo. Al di minuire della temperatura dell'aria si raggiungono le condizioni per cui il vapore acqueo inizia a con densare (temperatura dell'aria = temperatura di rugiada, umidità relativa = 100%). L'ulteriore sa lita dell'aria determina un calo di temperatura di:",
// 		answers: [
// 			'1°C ogni 100 m (Il gradiente è sostanzialmente costante con la quota).',
// 			'0.5°C circa ogni 100 m (Il gradiente non è co stante con la quota, ma al diminuire della tem peratura esso tende ad aumentare).',
// 			'2°C circa ogni 100 m.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '5057',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Come chiamiamo il sollevamento di aria alla presenza di fenomeni di condensazione del va pore acqueo?',
// 		answers: [
// 			'Sollevamento adiabatico saturo o in regime di saturazione.',
// 			'Sollevamento adiabatico anomalo perché in condizioni di saturazione.',
// 			'Sollevamento adiabatico secco perché in con dizioni di non saturazione.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5058',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Se il gradiente termico verticale della gior nata è superiore ad 1° C ogni 100 m l'aria si defi nisce:",
// 		answers: ['stabile.', 'instabile.', 'dotata di equilibrio indifferente.'],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		id: '5060',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Se l'aria risulta instabile dall'osservazione del suo gradiente termico verticale ci dovremo at tendere che:",
// 		answers: [
// 			"una bolla d'aria che si stacca dal suolo dotata di moto convettivo arresti la sua salita molto presto.",
// 			"una bolla d'aria che si stacca dal suolo dotata di moto convettivo continui nella sua salita con velocità sempre maggiore.",
// 			"una bolla d'aria che raggiunge una tempera tura di poco superiore a quella dell'aria circo stante riesca comunque a staccarsi dal suolo."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5061',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Una massa d\'aria molto umida, caratteriz zata da diffuse formazioni nuvolose, si dice "sta bile" quando:',
// 		answers: [
// 			'il suo gradiente termico verticale è inferiore al gradiente adiabatico saturo.',
// 			'il suo gradiente termico verticale è superiore ad 1°C ogni 100 m.',
// 			'il suo gradiente termico verticale è inferiore al gradiente adiabatico secco.'
...
// 		id: '5063',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "A una certa quota la temperatura am biente dell'aria è pari a 12°C. Se una bolla d'aria salendo si trova ad avere una temperatura di 14°C alla stessa quota essa:",
// 		answers: [
// 			'si arresterà immediatamente.',
// 			'inizierà sicuramente a scendere.',
...
// 		id: '5064',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Se una bolla d'aria contenente un'alta per centuale di umidità relativa inizia a salire dotata di moto convettivo, in che modo la condensazione del vapore acqueo influenza la sua salita?",
// 		answers: [
// 			'Probabilmente ne interrompe il moto ascensio nale.',
// 			'Sicuramente ne accelera il moto ascensionale.',
// 			'Probabilmente la condensazione del vapore ac queo non influenza il moto ascensionale.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5065',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Se l'aria è moderatamente instabile, una bolla d'aria umida che inizia a salire perché riscal data dal terreno più dell'aria circostante, raggiunta la quota di condensazione:",
// 		answers: [
// 			'salirà sicuramente più veloce.',
// 			'si arresterà sicuramente.',
// 			'inizierà una rapida discesa.'
...
// 		answers: [
// 			'vento di gradiente.',
// 			'bolle o colonne termiche dotate di moto ascen sionale.',
// 			'formazioni nuvolose a carattere stratificato.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '5070',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Le bolle termiche saranno facilitate a stac carsi da terra, a parità di altre condizioni, da:',
// 		answers: [
// 			'calma di vento su superfici prive di ostacoli.',
// 			'leggero venticello su superfici irte di ostacoli.',
// 			'leggero venticello su superfici prive di ostacoli.'
...
// 			"da condizioni di stabilità dell'aria.",
// 			"da condizioni di forte umidità dell'aria.",
// 			"da forte riscaldamento del terreno e dal conse guente riscaldamento per conduzione dell'aria sovrastante."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5072',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'La differente natura e colorazione del ter reno favorisce:',
// 		answers: [
// 			"il crearsi delle condizioni di instabilità dell'aria.",
// 			'il crearsi del vento di gradiente.',
// 			'il distacco di bolle o colonne termiche.'
...
// 		id: '5073',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Se non vi è umidità sufficiente a consen tire il raggiungimento delle condizioni di satura zione del vapore acqueo, le termiche che si forme ranno saranno chiamate:',
// 		answers: ['termiche secche o blu.', 'termiche adiabatiche.', 'termiche convettive.'],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5074',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Se l'aria è sufficientemente umida po tranno essere evidenziate le termiche esistenti e da che cosa?",
// 		answers: [
// 			'Si, dalla formazione di nubi stratificate ad una certa quota.',
// 			'Si, dalla formazione di nubi cumuliformi ad una certa quota.',
// 			'Si, ma comunque non dalla presenza di alcun tipo di nube.'
...
// 		id: '5076',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Oltre al moto convettivo dell'aria riscal data per conduzione dal terreno sottostante, si può verificare un movimento ascensionale dell'aria per altri motivi?",
// 		answers: [
// 			'Si, per sollevamento forzato in presenza di vento in corrispondenza di rilievi.',
// 			'Si, per sollevamento forzato in presenza di vento sulle pianure.',
// 			'No.'
...
// 		id: '5077',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Come si chiama il sollevamento dell'aria generato dalla presenza di vento in corrispon denza di rilievi montuosi?",
// 		answers: [
// 			'Sollevamento dinamico o "dinamica di pendio" in gergo volo liberistico.',
// 			'Sollevamento adiabatico.',
// 			'Sollevamento termodinamico.'
...
// 		id: '5078',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Può un iniziale sollevamento dinamico ge nerato dalla presenza di vento e di rilievi montuosi trasformarsi in sollevamento termico puro?',
// 		answers: [
// 			"Si, solo in presenza di condizioni di stabilità dell'aria.",
// 			"Si, in presenza di particolari condizioni di insta bilità dell'aria, con molte più probabilità al di sopra della quota di condensazione.",
// 			"No, neppure in presenza di particolari condi zioni di instabilità dell'aria."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5079',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Che cosa si potrà verificare qualora si stacchino delle bolle termiche alla presenza di vento moderato che sospinge l'aria su per un pen dio?",
// 		answers: [
// 			'Che si generino correnti ascensionali di note vole intensità.',
// 			'Che si generino solamente condizioni di forte turbolenza.',
// 			'Che prevalgano comunque le condizioni di "di namica" rispetto a quelle di "termica".'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5080',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Che cosa s'intende per inversione ter mica?",
// 		answers: [
// 			"Una diminuzione anomala della temperatura dell'aria ad una certa quota.",
// 			"Un andamento anomalo della temperatura dell'aria, quando essa aumenta con l'aumen tare della quota.",
// 			"L'inversione di moto di una bolla la cui tempe ratura ha raggiunto il valore di quella dell'aria circostante."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		id: '5082',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Come si riconosce dal pendio di decollo la presenza di un eventuale strato d'inversione sot tostante?",
// 		answers: [
// 			'Dalla presenza di foschia sotto lo strato di in versione, caratterizzata da un limite piuttosto netto.',
// 			'Dalla presenza di nubi convettive a partire dalla base dello strato stesso.',
// 			"Dalla presenza di una situazione di grande visi bilità al di sotto della base dello strato d'inver sione."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '5083',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Al decollo da un pendio, la presenza di uno strato d'inversione che tipo di messaggi può sug gerirci?",
// 		answers: [
// 			'Nessun messaggio meteorologico o aerologico particolare.',
// 			"Messaggi di sospetta possibile turbolenza an che forte e comunque di cambio delle condi zioni aerologiche all'attraversamento della base dello strato stesso.",
// 			'Qualche messaggio riguardante la possibilità di formazioni cumuliformi sopra lo strato stesso.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '5084',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Che cosa s\'intende per "perturbazione me teorologica" causata dal passaggio di un fronte?',
// 		answers: [
// 			"Il corpo nuvoloso ed i fenomeni associati alla presenza di una superficie di discontinuità esi stente tra due masse d'aria aventi caratteristi che fisiche diverse.",
// 			"Il corpo nuvoloso associato alle rapide varia zioni di pressione atmosferica al suolo dovuta all'avanzare delle masse d'aria.",
// 			"Il corpo nuvoloso associato a forti venti su ri lievi montuosi quando le masse d'aria si muo vono sul terreno."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 			"È la superficie di separazione tra una massa d'aria fredda che spostandosi raggiunge una massa d'aria più calda.",
// 			"È la superficie di separazione tra una massa d'aria calda che spostandosi raggiunge una massa d'aria più fredda.",
// 			'È un fenomeno non legato ad alcun evento me teorologico.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5086',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Quali fenomeni meteorologici genera nor malmente un fronte caldo al suo passaggio?',
// 		answers: [
// 			'Nubi a sviluppo prevalentemente verticale (ti picamente Cumuli congesti, Cumulonembi), precipitazioni violente ed a carattere disconti nuo o in forma di rovescio, con aumento della temperatura media.',
// 			'Nubi a sviluppo prevalentemente orizzontale a quote diverse (tipicamente Nembostrati, Alto strati e Strati), precipitazioni mediamente non violente ma a carattere continuo con aumento della temperatura media.',
// 			'Nubi a sviluppo orizzontale molto basse (tipica mente Strati e Stratocumuli), precipitazioni solo a carattere discontinuo e violento con au mento della temperatura media.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		id: '5088',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Quali fenomeni meteorologici genera nor malmente un fronte freddo al suo passaggio?',
// 		answers: [
// 			'Nubi a sviluppo orizzontale, precipitazioni a ca rattere debole e continuo con diminuzione della temperatura.',
// 			"Nubi a sviluppo verticale, precipitazioni a carat tere debole e continuo con diminuzione della temperatura e condizioni di stabilità dell'aria dopo il passaggio del fronte stesso.",
// 			"Nubi a sviluppo verticale, precipitazioni a carat tere violento e discontinuo con diminuzione della temperatura e condizioni di instabilità dell'aria dopo il passaggio del fronte stesso."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '5090',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Le nubi stratiformi, anche di notevole spessore (tipicamente Nembostrati più o meno ac compagnati da Altostrati e Strati) sono general mente associate al passaggio di:',
// 		answers: [
// 			'un fronte freddo.',
// 			'un fronte caldo.',
// 			'un fronte caldo o freddo su rilievi montuosi.'
...
// 		text: "Che cosa s'intende per fronte occluso?",
// 		answers: [
// 			"Una perturbazione complessa formata dall'in sieme di un fronte freddo che ha raggiunto un fronte caldo e che da luogo a tutti i fenomeni meteorologici caratteristici di entrambi i fronti.",
// 			'Una perturbazione a carattere freddo che in ef fetti dà luogo anche a tutti i fenomeni meteo rologici tipici di quelle a carattere caldo.',
// 			'Una perturbazione a carattere caldo che in ef fetti dà luogo anche a tutti i fenomeni meteo rologici tipici di quelle a carattere freddo.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 			'Strati, Nembostrati, Cirrostrati.',
// 			'Strati, Stratocumuli.',
// 			'Cumuli, Cirrocumuli, Stratocumuli, Cumulo nembi.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		id: '5096',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Come può essere definito il Cumulo con gesto?',
// 		answers: [
// 			'Un Cumulo in fase evolutiva avanzata caratte rizzato da un elevato sviluppo verticale.',
// 			'Un Cumulo di tipo particolare in fase iniziale di formazione.',
// 			"Un Cumulo che non riesce a svilupparsi com pletamente e a scaricare l'energia termodina mica accumulata."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		answers: [
// 			'Un particolare tipo di Cumulo la cui base è piatta e densa appunto come un Nembostrato.',
// 			'Una nube cumuliforme al culmine della sua fase evolutiva, caratterizzata dalla violenza dei fenomeni meteorologici a essa associati quali: precipitazioni a carattere temporalesco, feno meni elettrostatici, formazioni di ghiaccio e wind shear verticale ed orizzontale.',
// 			"Un particolare tipo di Cumulo, capace di gene rare fenomeni temporaleschi, che si forma esclusivamente in zone montuose d'estate al passaggio di una perturbazione a carattere freddo."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5098',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'In relazione al Volo Libero il Cumulo nembo può essere considerato come:',
// 		answers: [
// 			'una nube di grande utilità per il volo.',
// 			'una nube decisamente pericolosa per il volo.',
// 			'una nube che non riveste alcuna importanza ai fini del volo.'
...
// 			'Strato, Altocumulo, Cumulonembo, Cumulo.',
// 			'Nembostrato, Stratocumulo, Cumulonembo, Cumulo.',
// 			'Cumulo di ridotte dimensioni, Cumulo conge sto, Cumulonembo.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '5101',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'La presenza di dense nubi stratificate a varie quote, esclude la possibilità che vi siano an che formazioni nuvolose cumuliformi consistenti?',
// 		answers: [
// 			'Si, perché le nubi stratificate sono sintomo di fronte caldo nel quale non è possibile incon trare nubi convettive.',
// 			"No, perché l'aumento di temperatura dovuto al fronte caldo cui sono associate le nubi stratifi cate può dar luogo a sollevamento di aria con conseguente formazione di nubi a carattere convettivo.",
// 			'No, perché le nubi stratificate potrebbero es sere dovute al passaggio di un fronte occluso che può dar luogo altresì al formarsi di nubi convettive ed addirittura a carattere tempora lesco.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 			'nubi stratificate alte del genere Cirrocumuli che tendono a stratificarsi in Cirrostrati per poi evolvere in Cumuli evidenziando il fenomeno ondulatorio.',
// 			'nubi stratificate basse del genere Strato, indice di moti ondulatori.',
// 			"nubi lenticolari (in genere Altocumuli, ma tal volta anche Stratocumuli e/o Cirrocumuli) e nubi rotoriche (Cumulus fractus) che eviden ziano il fenomeno dell'onda orografica."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5103',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Una delle caratteristiche delle nubi lenti colari è:',
// 		answers: [
// 			'la tipica forma a sezione aerodinamica, simile a quella di una mandorla.',
// 			'il loro sviluppo verticale, nettamente superiore a quello orizzontale.',
// 			'la velocità di spostamento della nube.'
...
// 		id: '5106',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Generalmente le brezze di valle danno luogo a correnti di pendio anche sui versanti late rali delle valli stesse?',
// 		answers: [
// 			'Si, dipendentemente dalla morfologia del ter reno.',
// 			'Si, indipendentemente dalla morfologia del ter reno.',
// 			'No, in nessun caso.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '5108',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Può una brezza di valle essere tanto forte da costituire un rischio per i praticanti del Volo Li bero?',
// 		answers: [
// 			'Si, particolarmente in corrispondenza delle cre ste spartiacque.',
// 			'Si, particularly in corrispondenza di stroz zature o svolte a gomito della valle e del fondo valle stesso, per effetto Venturi.',
// 			'No, per nessun motivo.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 			'vento forte a scorrimento laminare.',
// 			'vento forte anche a raffiche con presenza di rotori con asse pressoché parallelo alle linee di massima pendenza dei pendii laterali della valle stessa.',
// 			"vento forte in presenza di rotori di diametro mi nimo con asse generalmente parallelo all'asse della valle stessa."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		answers: [
// 			'vento quasi calmo lungo i pendii vallivi, ma forte al fondo valle.',
// 			'vento a raffiche dovunque, con direzione im provvisamente variabile, sintomo della pre senza di rotori stazionari e migratori.',
// 			'vento anche forte ma a scorrimento laminare con direzione costante.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '5112',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: 'Se un rilievo isolato e tondeggiante è in vestito dal vento, si genereranno facilmente cor renti ascensionali?',
// 		answers: [
// 			"Si, perché il vento è costretto comunque a sca valcare l'ostacolo.",
// 			'Dipende unicamente dalla natura del terreno.',
// 			"No, perché il vento tende comunque ad aggi rare l'ostacolo."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'A volte la presenza di rotori di sottovento specialmente in corrispondenza di crinali e creste elevate è segnalata:',
// 		answers: [
// 			'da formazioni nuvolose dotate di grande velo cità di spostamento.',
// 			'da una particolare foschia nelle zone adiacenti il pendio sottovento.',
// 			'dalla presenza di nubi rotoriche stazionarie che si formano e si dissolvono continuamente e ve locemente.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5116',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Quando una catena montuosa è interes sata dall'avvezione di una massa d'aria molto umida che tende a scavalcarla, si determinano particolari fenomeni detti:",
// 		answers: [
// 			'Stau sopravento con pesanti formazioni nuvo lose e conseguenti precipitazioni, Foehn sotto vento con vento a raffiche più caldo e secco.',
// 			'Foehn sopravento con vento a raffiche caldo e secco, Stau sottovento con pesanti formazioni nuvolose e conseguenti precipitazioni.',
// 			'Stau e Foehn, con uguali conseguenze meteo rologiche e climatiche sopravento e sottovento.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		text: 'Nelle zone alpine del versante italiano, alla presenza del fenomeno di Foehn, sarà presente:',
// 		answers: [
// 			'aumento della temperatura, forte vento lami nare caldo e secco, assenza di rotori e turbo lenza.',
// 			'aumento della temperatura, forte vento a raf fiche caldo e secco, presenza di rotori e turbo lenza.',
// 			'aumento della temperatura, forte vento lami nare caldo e umido, assenza di rotori e turbo lenza.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5118',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "In presenza di una catena montuosa alta 3000 m aria umida ad una temperatura di pianura di 10°C si solleva dando luogo allo Stau sino in cresta e al Foehn in sottovento. Se la quota di con densazione sopravvento è di 1000 m quale sarà la temperatura dell'aria all'arrivo in pianura appena sotto alla catena montuosa?",
// 		answers: ['La stessa che sopravvento, cioè 10°C.', '13°C', 'Circa 20°C.'],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '5119',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Alla presenza di una catena montuosa alta 3000 m aria umida ad una temperatura di pianura di 10°C si solleva dando luogo a Stau sino in cresta e Foehn sottovento. Se la quota di condensazione sopravento è di 2000 m quale sarà la temperatura dell'aria all'arrivo in pianura appena sotto alla ca tena montuosa?",
// 		answers: ['La stessa che sopravvento, cioè 10°C', 'Circa 15°C.', '20°C'],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '5120',
// 		section: 'METEOROLOGIA E AEROLOGIA',
// 		text: "Quale tipo di microclima può avere una lo calità posta immediatamente sottovento a una ca tena montuosa come quella alpina, rispetto a spo stamenti di masse d'aria d'origine atlantica prove nienti abitualmente dalla pianura francese?",
// 		answers: [
// 			'Piuttosto siccitoso e ventoso a causa dei feno meni di Foehn.',
// 			'Molto umido e piovoso.',
// 			'Molto più freddo di quello esistente immediata mente sopravento.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 			'È lo strumento che misura sempre la distanza di un apparecchio dal suolo.',
// 			'È lo strumento che misura la velocità verticale di un apparecchio.',
// 			"È lo strumento che misura l'altitudine di un ap parecchio rispetto ad un punto noto come, ad esempio, il livello del mare."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '6002',
// 		section: 'STRUMENTI',
// 		text: 'Come funziona normalmente un altime tro?',
// 		answers: [
// 			"Misura la pressione atmosferica e quindi l'alti tudine, utilizzando una capsula aneroide o un sensore elettronico.",
// 			"Misura l'elevazione sul livello del mare utiliz zando un sensore elettronico.",
// 			"Misura la velocità verticale rispetto all'aria uti lizzando un sensore elettronico."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		text: 'Per quale motivo un altimetro necessita di regolazioni?',
// 		answers: [
// 			"Perché la temperatura dell'aria varia in rela zione alle condizioni atmosferiche ed al variare dell'altitudine.",
// 			"Perché la pressione atmosferica varia in rela zione alle condizioni atmosferiche e non solo in relazione all' altitudine.",
// 			"Perché la pressione atmosferica varia al variare dell'altitudine."
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '6004',
// 		section: 'STRUMENTI',
// 		text: "Dopo aver regolato l'altimetro all'altitudine di decollo, effettuiamo il volo. Se all'atterraggio esso ci indica un'altitudine diversa da quella cono sciuta, cosa può essere accaduto?",
// 		answers: [
// 			'La pressione atmosferica è cambiata.',
// 			"L'altimetro si è sicuramente guastato.",
// 			"La temperatura dell'aria è cambiata."
...
// 		text: 'Come funziona un variometro?',
// 		answers: [
// 			"Misura la variazione istantanea della tempera tura dell'aria a mezzo di un dispositivo elettro nico.",
// 			'Misura le variazioni anche minime di pressione atmosferica a mezzo di un barometro differen ziale o di un sensore elettronico.',
// 			'Misura le variazioni di pressione atmosferica a mezzo di un barometro a colonna.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		text: "In quali situazioni l'uso di un variometro può essere di grande aiuto per la sicurezza in volo?",
// 		answers: [
// 			"Ad esempio, volando con copertura nuvolosa o sotto un cumulo, le indicazioni del variometro ci possono aiutare a capire se c'è aspirazione e se è il caso o meno di affrettare la discesa verso l'atterraggio o dirigersi verso zone non sog gette al fenomeno.",
// 			'Nel volo di dinamica, in quanto ci aiuta a capire dove si sale meglio, permettendoci di prolun gare il volo senza rischi.',
// 			'Non è uno strumento da considerare utile ai fini della sicurezza del volo, ma solo come ausilio per il veleggiamento.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '6009',
// 		section: 'STRUMENTI',
// 		text: "Che cosa può misurare l'anemometro du rante un volo?",
// 		answers: [
// 			"È lo strumento che in volo misura la velocità all'aria.",
// 			'È lo strumento che in volo misura la velocità al suolo.',
// 			'È lo strumento che in volo misura la velocità verticale.'
...
// 		text: "In quale caso l'anemometro può indicare la velocità al suolo con buona approssimazione?",
// 		answers: [
// 			'Quando il volo è effettuato in aria calma, in as senza di vento e su traiettoria poco inclinata.',
// 			'In tutti i casi, indipendentemente dalla traiet toria.',
// 			'In nessun caso.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		answers: [
// 			'Rileva mediante una calamita la posizione in cui si trova il Nord geografico.',
// 			'Rileva mediante una calamita la direzione del campo magnetico terrestre e il Nord magne tico.',
// 			'Rileva mediante un sistema meccanico la dire zione dei meridiani terrestri.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '6014',
// 		section: 'STRUMENTI',
// 		text: 'A cosa si deve prestare attenzione se vo gliamo che la bussola funzioni nel modo più cor retto possibile posizionandola tra gli strumenti?',
// 		answers: [
// 			'A nulla in particolare, la bussola indica sempre il nord magnetico.',
// 			'A installarla in modo che il Nord magnetico coincida con il nord geografico.',
// 			"All'interferenza elettromagnetica con altri ap parati elettronici, tipo radiotrasmittenti e, so prattutto, apparecchi telefonici cellulari, che, entrando in funzione, possono disturbare il campo elettromagnetico influenzando l'ago della bussola."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '6015',
// 		section: 'STRUMENTI',
// 		text: "E' possibile affermare che il Nord geogra fico coincide con il Nord magnetico?",
// 		answers: ['Si.', "Dipende dalle stagioni dell'anno.", 'No.'],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '6016',
// 		section: 'STRUMENTI',
// 		text: 'Con bussola, altimetro, anemometro e va riometro è possibile effettuare attività vololiberi stica in condizioni di volo strumentale, ad esempio in nube?',
// 		answers: [
// 			'Si, se adeguatamente addestrati.',
// 			'Si, ma solo per breve tempo, perché la dota zione di strumenti non risulta completa.',
// 			"No, la dotazione di strumenti non è affatto completa, manca l'informazione di posizione nello spazio."
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '6018',
// 		section: 'STRUMENTI',
// 		text: 'Con il GPS è possibile volare con tranquil lità nelle nubi?',
// 		answers: [
// 			'Si, in quanto il GPS indica la direzione in cui mi sto muovendo con esattezza.',
// 			'No, anche perchè nella nube la ricezione del segnale inviato dai satelliti GPS può essere di sturbata, rendendo inaffidabile lo strumento.',
// 			'Si, ma solo se affianchiamo al GPS una bussola di tipo nautico.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '6019',
// 		section: 'STRUMENTI',
// 		text: 'Stiamo volando in presenza di vento molto forte. La nostra prua è diretta verso SUD. Sul di splay del GPS leggiamo una velocità di 3 km/h, di rezione NORD. Cosa succede?',
// 		answers: [
// 			'Lo strumento è evidentemente rotto.',
// 			"Se sono sicuro di avere la prua diretta verso SUD evidentemente sto volando all'indietro. Il vento è superiore alla mia velocità all'aria e oc corre aumentare la velocità prima possibile.",
// 			'Non è possibile che si verifichi una situazione del genere.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		answers: [
// 			'Calcola la posizione nello spazio mediante un sensore di movimento.',
// 			'Calcola la posizione nello spazio mediante il confronto dei segnali orari inviati da alcuni sa telliti in orbita intorno alla terra.',
// 			'Calcola la posizione nello spazio per mezzo di un barometro differenziale.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 			"nutrirsi adeguatamente, bere molto per evitare disidratazione, organizzare il recupero, dotarsi di mezzi per trascorrere eventualmente la notte all'addiaccio.",
// 			'provvedere a che il volo si svolga il mattino, più presto possibile, per disporre di più ore di luce.',
// 			"esaminare la carta aeronautica della zona, prendere nota di eventuali divieti e delle possi bilità di atterraggio lungo il percorso, nonché fare un'attenta valutazione delle condizioni me teorologiche."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'Quale inclinazione del pendio, assicurata la possibilità di una graduale e corretta rincorsa, è da considerarsi ottimale e sicura per il decollo?',
// 		answers: [
// 			'Oltre 120° e sino a 35°, risultando già così net tamente superiore alla pendenza della traietto ria di volo realizzabile.',
// 			'Dai 35° ai 45°, in quanto solo così risulta net tamente superiore alla pendenza della traietto ria di volo realizzabile.',
// 			'Oltre i 45°, per ottenere un rapido distacco dal terreno con garanzia di sorvolo degli ostacoli sulla traiettoria.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '7005',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Qual è in fase di decollo con deltaplano e parapendio, la prima manovra da eseguire appena staccati da terra oltre a quelle finalizzate al con trollo della direzione?',
// 		answers: [
// 			'Cabrare o trazionare i comandi rispettiva mente, per non perdere eccessiva quota.',
// 			"Sistemarsi adeguatamente nell'imbrago.",
// 			'Picchiare leggermente o rilasciare un poco i freni rispettivamente, per acquisire velocità.'
// 		],
// 		correct_answer_index: 2
...
// 		id: '7006',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Come è possibile ottenere, a prescindere da altre condizioni, il minor tasso di caduta possi bile con deltaplano e parapendio?',
// 		answers: [
// 			"Volando in linea retta ed all'incidenza massima consentita.",
// 			'Volando comunque al regime di massima effi cienza in aria calma.',
// 			'Volando in linea retta ad una incidenza com presa tra quella di massima efficienza in aria calma e quella di stallo.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '7007',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "Come varia l'efficienza all'aria di un'ala au mentando il vento frontale?",
// 		answers: [
// 			'Aumenta.',
// 			'Diminuisce.',
// 			"Non varia perché l'efficienza all'aria dipende solo dall'angolo d'incidenza dell'ala."
...
// 		id: '7008',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Se vogliamo comunque realizzare la mas sima autonomia chilometrica in deltaplano o para pendio dovremo:',
// 		answers: [
// 			'limitare al massimo le manovre.',
// 			'volare più possibile in linea retta ed al regime di massima efficienza al suolo.',
// 			'volare più possibile in linea retta ed al regime di minimo tasso di caduta.'
...
// 		id: '7009',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Se, in determinate condizioni aerologiche, vogliamo rimanere più tempo possibile in volo rea lizzando la massima autonomia oraria, dovremo:',
// 		answers: [
// 			'limitare al massimo le manovre.',
// 			"volare più possibile in linea retta ed al regime di massima efficienza all'aria.",
// 			'volare più possibile in linea retta ed al regime di minimo tasso di caduta ottenibile.'
...
// 		id: '7010',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Passando da condizioni di aria calma a condizioni di vento frontale, quale correttivo dob biamo apportare alla velocità per garantirci la mas sima efficienza al suolo possibile?',
// 		answers: [
// 			'Diminuire la velocità rispetto a quella di mas sima efficienza in aria calma.',
// 			'Aumentare la velocità rispetto a quella di mas sima efficienza in aria calma.',
// 			'Aumentare comunque la velocità sino alla mas sima possibile.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '7011',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "Volando in deltaplano o parapendio sap piamo che l'efficienza al suolo, quando il vento frontale varia, comunque:",
// 		answers: ['varia.', 'varia, ma solo se il vento frontale aumenta.', 'rimane invariata.'],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		id: '7013',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'In condizioni di ascendenza la massima ef ficienza al suolo si realizza volando:',
// 		answers: [
// 			'con una incidenza maggiore di quella corri spondente al regime di massima efficienza in aria calma.',
// 			'con una incidenza minore di quella corrispon dente al regime di massima efficienza in aria calma.',
// 			"comunque con l'incidenza corrispondente al re gime di massima efficienza in aria calma."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		id: '7015',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "Stiamo volando ad una velocità rispetto al suolo di 10 km/h. C'è una componente di vento contrario pari a 30 km/h. Se avessimo l'anemome tro quanto indicherebbe?",
// 		answers: ['10 km/h.', '20 km/h.', '40 km/h.'],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'In presenza di vento meteorologico, come si esegue una virata di 360° la cui traccia al suolo sia più possibile circolare?',
// 		answers: [
// 			"Variando opportunamente l'inclinazione dell'ala durante la virata in funzione della deriva do vuta allo spostamento dell'aria rispetto al suolo.",
// 			"Accentuando l'inclinazione laterale dell'ala du rante la fase della virata con vento in prua.",
// 			"Diminuendo l'inclinazione laterale dell'ala du rante le fasi della virata con vento al traverso."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '7019',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Come si eseguono le virate in dinamica di pendio ed in prossimità dello stesso, se si vuole avere il miglior rendimento garantendosi il mas simo della sicurezza?',
// 		answers: [
// 			"Eseguendo virate strette di 360° nel punto in corrispondenza del quale è massima l'ascen denza.",
// 			'Eseguendo lunghi "otto" con inversioni di 180° ad alti angoli di inclinazione per rimanere in vi rata meno possibile.',
// 			'Utilizzando la tecnica "a granchio" che con sente di eseguire degli "otto" sul pendio evi tando di assumere elevati angoli di rollio.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'Perché si fanno virate di 360° in termica?',
// 		answers: [
// 			'Perché le termiche hanno sempre e solo un an damento ascendente elicoidale.',
// 			"Per potersi mantenere all'interno della corrente ascensionale.",
// 			'Perché in virata continua, il tasso di caduta ri sulta essere minore.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		answers: [
// 			'interviene sui comandi per ridurre la velocità.',
// 			'interviene sui comandi per aumentare la velo cità.',
// 			'non interviene più sui comandi per variare il re gime di volo.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '7022',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'È possibile andare in stallo volando a ve locità prossima alla massima?',
// 		answers: [
// 			'No.',
// 			"Si, se si diminuisce improvvisamente l'inci denza.",
// 			"Si, se si aumenta improvvisamente l'incidenza oltre certi valori."
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		text: 'A quale velocità è opportuno volare in forte turbolenza?',
// 		answers: [
// 			'Alla minima possibile per ridurre le sollecita zioni nel delta e per garantire la massima pres sione nei cassoni del parapendio.',
// 			'Alla massima possibile indipendentemente dalle sollecitazioni per uscirne al più presto.',
// 			'Ad una velocità di poco superiore a quella di massima efficienza in aria calma in delta ed alla massima compatibile con il mantenimento di adeguata pressione nei cassoni in parapendio.'
// 		],
// 		correct_answer_index: 2
...
// 			"Osservando ogni cosa che il vento può mettere in movimento (fumo, bandiere, panni appesi, alberi) e considerando l'eventuale presenza di deriva.",
// 			"Osservando il segnavento del deltaplano o del parapendio se istallato, o valutando l'intensità del vento relativo in varie direzioni di volo.",
// 			'Osservando il movimento delle nubi che è sem pre possibile mettere in relazione con il vento al suolo.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '7025',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Che cosa si intende per circuito di avvici namento ad "otto"?',
// 		answers: [
// 			'Un tipo di avvicinamento che consente al pilota di effettuare poche virate per arrivare in atter raggio.',
// 			'Un tipo di avvicinamento che, con virate di oltre 180° sempre verso la superficie di atterraggio, consente al pilota di perdere quota mantenen dosi costantemente in prossimità ed in vista di esso.',
// 			"Un tipo di avvicinamento che consente al pilota di perdere quota facendo delle virate molto strette pur di mantenersi in prossimità dell'at terraggio."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		answers: [
// 			'Un tipo di avvicinamento composto da tre fasi distinte dette "sottovento", "base" o "virata base" e "finale" che consente di arrivare al suolo con buona precisione evitando di fare molte manovre vicino al terreno.',
// 			'Un tipo di avvicinamento molto complesso, co stituito da molte fasi distinte e caratterizzato da manovre da farsi vicino al suolo.',
// 			'Un tipo di avvicinamento valido solo per gli ae romobili e quindi non adatto al deltaplano ed al parapendio.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		id: '7028',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'In un atterraggio in cui si presentano con temporaneamente molti deltaplani e parapendio, sarà opportuno:',
// 		answers: [
// 			'impostare gli avvicinamenti con la tecnica a "C" rispettando le precedenze ed avviandosi all\'at terraggio quando si è più in basso degli altri.',
// 			'impostare gli avvicinamenti con la tecnica a "otto" rispettando le precedenze ed avviandosi all\'atterraggio quando si è più in basso degli al tri.',
// 			"impostare gli avvicinamenti con l'una o l'altra tecnica fatto salvo il rispetto delle precedenze."
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '7029',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Quando è necessario tenere particolar mente conto del gradiente del vento?',
// 		answers: [
// 			'Volando in termica.',
// 			'In atterraggio o durante il volo in prossimità del pendio.',
// 			'In decollo perché la velocità del vento sicura mente diminuisce allontanandosi dal suolo.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 			'ben oltre il traverso del punto di contatto.',
// 			'non al di sopra dei 50 m di quota.',
// 			'non troppo oltre il traverso del punto di con tatto.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		answers: [
// 			"attendersi una traiettoria ripida, aumentare la velocità all'aria al massimo per minimizzare l'ef fetto del gradiente del vento o del wind shear, raccordare moderatamente e solo in prossimità del suolo.",
// 			'cercare di assumere la traiettoria più ripida possibile mantenendo la velocità di minimo tasso di caduta, in previsione del gradiente di vento raccordare moderatamente e solo in prossimità del suolo.',
// 			"indipendentemente dalla traiettoria che ne ri sulta mantenere la minima velocità all'aria pos sibile e stallare non appena si incontrano con dizioni di gradiente del vento."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 			'un aumento improvviso del tasso di caduta con probabile picchiata del mezzo che è possibile prevenire con una buona dose di velocità.',
// 			"una improvvisa diminuzione di velocità al suolo per l'aumentata componente di vento contrario che non crea problemi di pilotaggio.",
// 			"una perdita improvvisa di quota che non si può compensare aumentando decisamente l'inci denza."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		answers: [
// 			'poter stallare meglio in prossimità del suolo.',
// 			'evitare gli effetti negativi di eventuale gra diente del vento o wind shear.',
// 			'avvicinarsi al terreno con una traiettoria più ri pida.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '7035',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Il vento in atterraggio è sostenuto, vo lando in deltaplano o parapendio, per aumentare il margine di sorvolo di eventuali ostacoli lungo la traiettoria, al pilota conviene tra le seguenti solu zioni:',
// 		answers: [
// 			"aumentare la velocità all'aria perché solo così facendo si ottiene la massima efficienza suolo possibile e quindi la minor pendenza di traiet toria reale.",
// 			"diminuire la velocità all'aria onde ottenere il mi nimo tasso di caduta possibile.",
// 			'volare comunque al regime di massima effi cienza in aria calma per ottenere la minor pen denza di traiettoria.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '7036',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Quando è necessario controllare che i cor dini del parapendio non siano attorcigliati o aggro vigliati?',
// 		answers: [
// 			"Dopo aver gonfiato, sollevato e frenato quanto basta l'ala in fase di decollo.",
// 			'Subito dopo essere atterrati prima di riporre il parapendio.',
...
// 		id: '7037',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Durante un volo di cross non sempre è possibile atterrare dove previsto. Il pilota do vrebbe conoscere perfettamente:',
// 		answers: [
// 			'la tecnica per atterrare senza inconvenienti in un preciso punto di un pendio o una superficie ridotta.',
// 			'le tecniche di sopravvivenza in montagna per salvaguardarsi in attesa di recuperi.',
// 			'le tecniche per effettuare atterraggi con il vento anche forte in coda per poter atterrare comunque anche su piccole superfici circon date da eventuali ostacoli.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '7038',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Immediatamente prima di effettuare un decollo in parapendio è necessario eseguire i con trolli di sicurezza che sono:',
// 		answers: [
// 			'scarpe allacciate, selletta allacciata e regolata come previsto, bretelle e cordini correttamente predisposti ed impugnati, ala in posizione cor retta, casco allacciato, vento e condizioni me teo favorevoli, spazio aereo libero.',
// 			"casco e guanti indossati, terreno sgombro ed adatto, cassoni dell'ala aperti, vento favorevole e spazio aereo libero.",
// 			"moschettoni o maillons serrati, integrità dell'ala verificata, selletta correttamente collegata all'ala, freni liberi."
// 		],
// 		correct_answer_index: 0
...
// 		id: '7039',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "Nel parapendio oltre a curare che la posi zione del pilota risulti in volo quella corretta, è in dispensabile, affinché l'ala mantenga le caratteri stiche garantite dall'omologazione, verificare che il tipo di selletta usato sia compatibile e che vengano rispettate le seguenti disposizioni:",
// 		answers: [
// 			'regolare la selletta per ottenere che la distanza tra le bretelle (destra e sinistra) sia sempre su periore a 40 cm.',
// 			'regolare la selletta in modo che il pilota possa comunque arrivare ad afferrare i cordini ante riori esterni ben sopra i maillons.',
// 			'regolare la selletta in modo che la distanza tra le bretelle (destra e sinistra) nonché tra i mail lons ed il piano della selletta sia quella prevista e riportata sulla targhetta di omologazione.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '7040',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Se ci rendiamo conto che il nostro para pendio è umido, quali accorgimenti dobbiamo adottare durante il volo:',
// 		answers: [
// 			'effettuare le "orecchie" per scendere più velo cemente.',
// 			'non ci sono particolari accorgimenti da adot tare, perché la vela umida non presenta alcun problema di assetto.',
// 			"pilotare l'ala con dolcezza rimanendo nella fa scia alta delle velocità."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '7041',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "Il gonfiaggio del parapendio fronte all'ala (spalle al vento) è particolarmente consigliato:",
// 		answers: [
...
// 		id: '7042',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Le fasi in cui è possibile pensare di suddi videre il decollo in parapendio sono:',
// 		answers: [
...
// 		id: '7043',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "Dopo il gonfiaggio del parapendio fronte all'ala finalizzato al decollo, al fine di evitare che l'ala si scomponga o passi davanti nel momento in cui ci si gira e si inizia la rincorsa, è importante:",
// 		answers: [
// 			'che la rotazione del pilota avvenga veloce mente.',
// 			'che il pilota abbandoni le maniglie dei freni prima di girarsi per poi riprenderle pronta mente fronte al pendio.',
...
// 		id: '7044',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'È possibile il decollo in parapendio con li mitata componente di vento al traverso?',
// 		answers: [
...
// 			'No, il decollo in queste condizioni risulta prati camente impossibile anche al pilota più esperto.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '7045',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Un corretto decollo in parapendio è quello in cui il pilota:',
// 		answers: [
// 			"valutata comunque sufficiente la portanza pro dotta dall'ala interrompe la rincorsa e si si stema al più presto nella selletta.",
...
// 			"controllata e verificata l'ala adeguatamente, con busto in avanti corre con velocità in pro gressivo aumento sino allo stacco."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '7046',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'La sequenza di interruzione di un decollo in parapendio dovrebbe essere:',
// 		answers: [
...
// 		id: '7048',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Se dopo il decollo si constata una chiusura laterale del parapendio, come deve comportarsi il pilota?',
// 		answers: [
// 			"Mantenere o ristabilire il controllo direzionale dell'ala e solo dopo averlo fatto intervenire op portunamente per provocare la riapertura dell'estremità collassata.",
...
// 			"Intervenire immediatamente per provocare la riapertura dell'estremità collassata mante nendo trazionato a fondo il freno dalla parte della chiusura."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '7049',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "E' possibile eseguire virate in parapendio con il solo spostamento laterale del peso del pi lota?",
// 		answers: [
// 			'Si, in modo più o meno accentuato, dipenden temente dal tipo di selletta e dalla sua regola zione.',
...
// 		id: '7050',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Volendo sfruttare al meglio le prestazioni del parapendio, sarà opportuno che il pilota ese gua virate utilizzando il peso e successivamente:',
// 		answers: [
// 			'rilasci entrambi i freni per poi trazionare quello interno alla virata.',
// 			"rilasci, se trazionato, il freno situato dalla parte opposta al senso di virata per poi modulare l'in clinazione con entrambi i comandi.",
// 			'trazioni il freno interno per impostare la mas sima inclinazione.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		text: 'Il parapendio è un mezzo che presenta il vantaggio di poter girare abbastanza stretto da non uscire da una eventuale termica anche se di modeste dimensioni. Quali delle seguenti opzioni è preferibile per sfruttare meglio questo tipo di condizioni?',
// 		answers: [
// 			'Scegliere un ottimo compromesso tra inclina zione laterale e tasso di caduta che consenta comunque di non uscire dalla termica, tenendo conto del suo andamento verticale.',
// 			'Eseguire comunque virate più piatte possibile per ottenere il minimo tasso di caduta.',
// 			'Effettuare degli "otto" in modo tale da rimanere entro i limiti della termica stessa.'
// 		],
// 		correct_answer_index: 0
...
// 		id: '7052',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "E' possibile provare l'avvicinamento allo stallo in parapendio e con quale tecnica per garan tirsi adeguati margini di sicurezza?",
// 		answers: [
...
// 		text: 'Come si riconosce uno stallo paracadutale del parapendio?',
// 		answers: [
// 			"Ala perfettamente gonfia, velocità all'aria pra ticamente nulla, tasso di caduta elevato.",
// 			"Ala perfettamente gonfia, velocità all'aria pra ticamente nulla, tasso di caduta normale, forti vibrazioni sui comandi.",
// 			"Ala con chiusura laterale, velocità all'aria prati camente nulla, tendenza dell'ala all'auto rota zione."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 			'Effettuare virate continue che consentono di aumentare il carico alare.',
// 			"Fare volare l'ala in condizioni di stallo.",
// 			'Le "orecchie", i "wing over" e la spirale pic chiata.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '7056',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Qual è il risultato di una simmetrica e leg gera tensione esercitata sugli elevatori posteriori del parapendio?',
// 		answers: [
// 			'Aumento della velocità e diminuzione della por tanza.',
// 			"Variazione dell'assetto, dell'incidenza, della ve locità.",
// 			'Diminuzione della sola incidenza.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		text: 'In volo rettilineo in uscita da una virata, se per effetto di una sovracorrezione si innescano oscillazioni laterali del parapendio il pilota dovrà:',
// 		answers: [
// 			'cercare di smorzarle insistendo ad agire sui co mandi in contro fase.',
// 			'rilasciare completamente i comandi per qual che secondo e poi iniziare una virata accen tuata a destra o sinistra.',
// 			"rallentare trazionando con una certa decisione ed in modo simmetrico i comandi sino ad otte nere la stabilizzazione dell'ala."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '7060',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "La corretta sequenza in finale per l'atter raggio in parapendio, in condizioni di vento mode rato, è:",
// 		answers: [
// 			"massima velocità all'aria sino a circa un metro dal suolo quindi intervento deciso sui comandi per provocare lo stallo.",
// 			"massima velocità all'aria possibile sino a circa 4 o 5 metri dal suolo, primo intervento sui co mandi per diminuire velocità e pendenza (freni trazionati circa al 20%), graduale ma completa frenata in prossimità del suolo sino al contatto.",
// 			'regime di minimo tasso di caduta sino a circa due metri dal suolo quindi graduale intervento sui comandi sino a provocare lo stallo.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '7061',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Nella zona di decollo abbiamo vento suffi ciente a consentire un gonfiaggio fronte vela ma il vento è laterale (25 gradi) rispetto alla massima pendenza del terreno.',
// 		answers: [
// 			'Predisponiamo la vela per il gonfiaggio lungo la massima pendenza per sfruttarla al meglio.',
// 			'Orientiamo la vela contro vento per gonfiarla e successivamente eseguiamo la corsa di decollo lungo la massima pendenza.',
// 			'Orientiamo la vela contro vento per gonfiarla e successivamente decolliamo lungo questa dire zione.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '7062',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Decollo in deltaplano. Tra i controlli di si curezza pre-decollo, uno in particolare risulta es senziale e deve essere eseguito con una tecnica ed una cura particolare perché ha causato svariati e gravi incidenti:',
// 		answers: [
// 			'il controllo del posizionamento del deltaplano.',
// 			"il controllo dell'avvenuto aggancio del pilota al deltaplano.",
// 			'il controllo del corretto ripiegamento del para cadute di emergenza.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		text: "Come è necessario verificare nel miglior modo l'avvenuto corretto aggancio del pilota al deltaplano?",
// 		answers: [
// 			"Facendo sorreggere la chiglia del deltaplano da un assistente, disponendosi in posizione oriz zontale di volo sospesi all'aggancio, verificando oltre all'aggancio stesso la posizione del corpo rispetto alla barra.",
// 			"Agganciando il moschettone e verificando at tentamente con un controllo visivo che l'aggan cio stesso sia correttamente avvenuto.",
// 			"Facendo verificare dall'assistente che l'aggan cio sia stato correttamente effettuato."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		id: '7065',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Se il vento è angolato entro i 45° rispetto alla direzione di decollo, è possibile decollare in deltaplano e come?',
// 		answers: [
// 			'No, anche se la componente è moderata.',
// 			'Si, se la componente è limitata, correndo lungo la linea di massima pendenza con la prua par zialmente orientata contro vento.',
// 			'Si, anche se la componente è sostenuta, pur ché si corra contro vento.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		text: 'Se il pilota intraprende la corsa di decollo con il deltaplano molto cabrato:',
// 		answers: [
// 			'il decollo avviene prima ed è possibile sorvolare con più margine eventuali ostacoli sulla traiet toria.',
// 			'il decollo avviene a velocità più bassa ed è più semplice il controllo del deltaplano dopo il de collo.',
// 			'il decollo avviene con incidenza troppo elevata, la traiettoria che ne risulta è ripida ed è alto il rischio di stallo.'
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '7067',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "È possibile l'interruzione di decollo in del taplano e quali rischi comporta eventualmente?",
// 		answers: [
// 			'Si, solo in caso di estrema necessità, con alta probabilità di danni alla struttura e conse guenze per il pilota.',
// 			'Si, ogniqualvolta lo si ritenga necessario senza particolari problematiche se si conosce e si ap plica la tecnica corretta.',
// 			'Si, purché non la si effettui quando si è pros simi allo stacco e si abbia una discreta espe rienza.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		id: '7070',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Individuare la corretta sequenza per effet tuare una virata in deltaplano:',
// 		answers: [
// 			'presa di velocità, spostamento laterale del corpo rispetto alla barra parallelamente alla chiglia, spinta sulla barra per coordinare la vi rata, riposizionamento del corpo in posizione centrata rispetto alla barra.',
// 			'presa di velocità, spostamento laterale del corpo rispetto alla barra parallelamente alla chiglia, riposizionamento del corpo in posizione centrata rispetto alla barra.',
// 			"presa di velocità, spinta asimmetrica per otte nere una rotazione del deltaplano attorno all'asse verticale, contemporaneo spostamento laterale del corpo rispetto alla barra, riposizio namento del corpo in posizione centrata ri spetto alla barra."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		id: '7072',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Come si esegue il controllo di rollio in del taplano?',
// 		answers: [
// 			"Facendo semplicemente ruotare l'asse del corpo rispetto alla barra.",
// 			'Spostando lateralmente il corpo e facendo nello stesso tempo ruotare il suo asse rispetto alla barra.',
// 			'Spostando lateralmente il corpo rispetto alla barra, sempre mantenendolo parallelo alla chi glia.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '7074',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'A distanza di sicurezza dal terreno, come si esegue correttamente una prova di stallo in del taplano?',
// 		answers: [
// 			"Si spinge dolcemente e gradualmente sulla barra per aumentare l'angolo di incidenza sino allo stallo ed a stallo avvenuto si ottiene la ri messa riaumentando la velocità al mezzo.",
// 			"Si spinge in avanti sui montanti per ottenere angoli d'incidenza più elevati, e si mantiene questa posizione per almeno 30 secondi.",
// 			"Dopo adeguata presa di velocità si spinge sulla barra con decisione e rapidità per ottenere un brusco aumento dell'incidenza."
// 		],
// 		correct_answer_index: 0
...
// 		id: '7075',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Come deve comportarsi il pilota di delta plano una volta entrato in termica se vuole sfrut tarla?',
// 		answers: [
// 			'Mantenere il regime di minimo tasso di caduta ed effettuare delle virate di 360° per rimanere in termica.',
// 			'Mantenere il regime di massima efficienza ed effettuare delle virate di 360° per rimanere in termica.',
// 			'Mantenere sempre la minima velocità possibile ed effettuare delle virate accentuate di 360° per rimanere in termica.'
...
// 		id: '7077',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: 'Come è possibile intervenire per aumen tare la velocità di trim del deltaplano?',
// 		answers: [
// 			'Spostando indietro il punto di aggancio del pi lota rispetto alla struttura.',
// 			'Spostando in avanti il punto di aggancio del pi lota rispetto alla struttura.',
// 			'Spostando in alto il punto di aggancio del pilota rispetto alla struttura.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '7078',
// 		section: 'TECNICA DI PILOTAGGIO',
// 		text: "La corretta sequenza in finale per l'atter raggio con il deltaplano in condizioni di vento mo derato è:",
// 		answers: [
// 			'raccordare adeguatamente in prossimità del suolo, mantenendo una traiettoria orizzontale sino al momento di "aprire" per stallare il del taplano alla minima velocità di sostentamento possibile.',
// 			'raccordare adeguatamente a 4 o 5 metri dal suolo, mantenendo poi una traiettoria lieve mente picchiata sino al momento di "aprire" per stallare il deltaplano ad una velocità ancora ben superiore alla minima di sostentamento.',
// 			'raccordare adeguatamente in prossimità del suolo, mantenendo una traiettoria orizzontale sino in prossimità del punto di contatto presta bilito quindi "aprire" con decisione per stallare il deltaplano, indipendentemente dalla velocità raggiunta.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		id: '8001',
// 		section: 'MATERIALI',
// 		text: 'È più preoccupante un taglio sulla superfi cie del parapendio in corrispondenza:',
// 		answers: [
// 			"della parte anteriore centrale dell'estradosso.",
// 			"della parte posteriore laterale dell'estradosso.",
// 			"della parte posteriore laterale dell'intradosso."
...
// 		id: '8003',
// 		section: 'MATERIALI',
// 		text: 'Durante il volo in parapendio sono sotto posti al maggior carico i cordini:',
// 		answers: ['anteriori.', 'posteriori.', 'laterali.'],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		answers: [
// 			'Che il tessuto stesso non può strapparsi, ma solo tagliarsi.',
// 			'Che un eventuale taglio o strappo nel tessuto ha molte probabilità di estendersi pericolosa mente.',
// 			'Che un eventuale taglio o strappo nel tessuto ha poche probabilità di estendersi pericolosa mente.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'Il tessuto con cui è generalmente costruito un parapendio deve essere:',
// 		answers: [
// 			"resistente all'usura, molto elastico e gas per meabile.",
// 			"resistente all'usura, anelastico e gas permea bile.",
// 			"resistente all'usura, anelastico e non gas per meabile."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '8006',
// 		section: 'MATERIALI',
// 		text: 'Quali agenti esterni danneggiano mag giormente il tessuto di un parapendio rendendolo fragile e gas-permeabile?',
// 		answers: [
// 			"I raggi ultravioletti e l'umidità.",
// 			"I raggi infrarossi e l'umidità.",
// 			'I raggi infrarossi ed il caldo secco.'
...
// 		answers: [
// 			'risulta compromesso solo il suo aspetto.',
// 			'risultano un poco degradate solo le sue presta zioni.',
// 			'risultano degradate le sue prestazioni e com promessa la sua affidabilità.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'Dovendo riporre un parapendio si avrà cura di farlo:',
// 		answers: [
// 			'solo se la vela è asciutta ed in luogo secco, lon tano da fonti di calore ed al riparo dalla luce solare.',
// 			'solo se la vela è asciutta, in ambiente modera tamente umido e caldo, al riparo dalla luce so lare.',
// 			"anche se è un poco umido, purché in luogo caldo, lasciando il sacco contenitore aperto onde consentire all'umidità di evaporare."
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		id: '8009',
// 		section: 'MATERIALI',
// 		text: "Il cordino di un parapendio è rimasto im pigliato ed il kevlar che ne costituisce l'anima è ora privo di rivestimento, ma integro:",
// 		answers: [
// 			'provvisoriamente lo accorciamo annodandolo per evitare che la parte scoperta sia soggetta a trazione.',
// 			'provvisoriamente lo rivestiamo con nastro iso lante onde evitare di esporre alla luce il tratto di kevlar scoperto.',
// 			'provvisoriamente aggiungiamo con opportuni nodi un altro pezzo di cordino al tratto scoperto per creare un rinforzo.'
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '8010',
// 		section: 'MATERIALI',
// 		text: "Decidiamo di sostituire i maillons dell'im brago con moschettoni. Avremo cura di:",
// 		answers: [
// 			'verificare che questi ultimi siano omologati e provvisti di ghiera a vite o a scatto.',
// 			'verificare che questi ultimi siano montati cor rettamente.',
// 			"usare moschettoni di tipo leggero per non ap pesantire l'imbrago stesso."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '8011',
// 		section: 'MATERIALI',
// 		text: 'Che cosa è necessario verificare in corri spondenza di piombature di cavi e tiranti del del taplano?',
// 		answers: [
// 			'Che i cavi ed i tiranti non siano rotti sotto la piombatura.',
// 			'Che le piombature siano semplicemente in buono stato.',
// 			'Che le piombature siano in buono stato ed i cavi o tiranti non presentino segni di logora mento in vicinanza delle piombature stesse.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'Se ci accorgiamo che qualche tirante del deltaplano è sfilacciato o logoro:',
// 		answers: [
// 			'lo sostituiamo immediatamente prima di rian dare in volo.',
// 			'lo ripariamo alla meglio non potendolo sosti tuire immediatamente.',
// 			'andiamo in volo facendo attenzione a non sol lecitare la struttura con particolari manovre.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '8013',
// 		section: 'MATERIALI',
// 		text: "Durante l'ultimo volo in deltaplano ab biamo effettuato un atterraggio pesante. Il cross bar ed un montante si sono piegati:",
// 		answers: [
// 			'riandiamo in volo avendo sostituito il montante e raddrizzato perfettamente il cross bar.',
// 			'riandiamo in volo solo dopo aver sostituito il montante ed il cross bar con ricambi originali.',
// 			'riandiamo in volo avendo raddrizzato perfetta mente montante e cross bar.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 		answers: [
// 			'farlo in apposita sacca quando siamo certi che è perfettamente asciutto, sistemandolo in luogo meno umido possibile, lontano dalla luce del sole e da fonti di calore.',
// 			"sistemarlo in apposita sacca dopo aver effet tuato l'ultimo volo, riporlo su appositi supporti fissati alle pareti di uno scantinato dove non può essere raggiunto dalla luce del sole.",
// 			'lasciarlo ripiegato senza sacca, sistemandolo possibilmente in uno scantinato o in garage dove non può essere raggiunto dalla luce del sole, possibilmente su appositi supporti fissati alle pareti.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		text: 'Se in corrispondenza di qualche elemento costituente il corredo di tiranteria o bulloneria del deltaplano si riscontra presenza di ruggine:',
// 		answers: [
// 			'è necessario prima di volare rimuoverla pron tamente usando appositi prodotti antiruggine sul particolare interessato.',
// 			"è possibile comunque intraprendere il volo pur ché si sia accertata l'integrità del particolare in teressato.",
// 			'è indispensabile sostituire il particolare in que stione con altro idoneo di identiche caratteristi che, prima di intraprendere qualsiasi tipo di volo.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		answers: [
// 			'Mai aprirlo perché si potrebbe commettere un errore nel ripiegarlo.',
// 			'Aprirlo alle scadenze previste o se bagnato e ripiegarlo sotto la supervisione di persone com petenti.',
// 			'Aprirlo, farlo asciugare in luogo asciutto e ripie garlo solo se siamo certi che sia bagnato o inu midito.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '8018',
// 		section: 'MATERIALI',
// 		text: 'Riguardo al paracadute di soccorso è ne cessario accertare prima di ogni volo che:',
// 		answers: [
// 			"la maniglia di azionamento sia all'interno della sacca di lancio.",
// 			"non sia stato aperto anche solo per ispezione, in quanto la ripiegatura non eseguita dal co struttore non garantisce l'apertura.",
// 			'la fune di vincolo sia saldamente ancorata, la sacca correttamente posizionata, la maniglia di azionamento sia facilmente raggiungibile ed azionabile.'
// 		],
// 		correct_answer_index: 2
// 	},
...
// 		id: '8019',
// 		section: 'MATERIALI',
// 		text: 'Per quale motivo un paracadute di soc corso che non sia stato sottoposto a periodica ispezione non garantisce sufficiente affidabilità?',
// 		answers: [
// 			'Perché il materiale con cui è fabbricato si dete riora rapidamente se non gli si fa prendere aria ogni tanto.',
// 			'Perché il materiale con cui è fabbricato può "in collarsi" per effetto del ripiegamento nella sacca, non garantendo una corretta e pronta apertura in caso di bisogno.',
// 			'Perché la fune di vincolo deve essere verificata ogni tanto in quanto può deteriorarsi con il ri schio che si strappi in caso di utilizzo.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '8020',
// 		section: 'MATERIALI',
// 		text: 'Il materiale e la tecnologia con cui sono fabbricati i paracadute di soccorso per il volo libero garantiscono totale sicurezza per aperture effet tuate:',
// 		answers: [
// 			'a qualsiasi velocità di caduta.',
// 			'a velocità di caduta contenute entro certi limiti indicati dal costruttore.',
// 			'solo a velocità pari a quelle massime del delta plano e del parapendio.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '9001',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'La sicurezza del volo in deltaplano e para pendio dipende moltissimo dal rapporto esistente tra esperienza del pilota e caratteristiche del mezzo utilizzato?',
// 		answers: ['Si.', 'Assolutamente no.', 'Si, ma solo se si tratta di volo in condizioni forti.'],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '9002',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "La sicurezza del volo in deltaplano e para pendio dipende tra l'altro anche dal rapporto tra l'esperienza del pilota e le condizioni meteo affron tate?",
// 		answers: ['Assolutamente no.', 'Si.', 'Si, ma solo se si tratta di un volo di cross.'],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '9003',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Ci viene proposto l'acquisto di un'ala omo logata alla quale sono state però apportate delle modifiche che ne migliorano le prestazioni. Qual è l'atteggiamento più conservativo da tenere sotto il profilo della sicurezza?",
// 		answers: [
// 			'Prendere in considerazione il mezzo ma solo dopo averlo personalmente provato al limite delle prestazioni.',
// 			'Acquistarlo solo se chi ce lo propone è persona esperta e fidata.',
// 			'Respingere la proposta orientando esclusiva mente le proprie scelte su mezzi provvisti di omologazione ed assolutamente conformi al modello originale.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '9004',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Quando va effettuata la revisione perio dica dei mezzi?',
// 		answers: [
// 			'Quando si notano reazioni anomale o si sospet tano variazioni nelle prestazioni del mezzo.',
// 			'Ad intervalli definiti dal costruttore perché le caratteristiche dei materiali subiscono varia zioni anche solo per invecchiamento.',
// 			"Ad intervalli definiti dal costruttore se si vola assiduamente, riducendo la frequenza se si vola meno a patto di conservare l'attrezzatura con cura."
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '9005',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Omettere o trascurare i controlli di sicu rezza pre-volo:',
// 		answers: [
// 			"è senz'altro pericoloso.",
// 			'è tecnicamente scorretto.',
// 			"può non essere pericoloso se l'esperienza è molta."
...
// 			'è utile superare ogni indugio ed intraprendere il volo per migliorare le proprie capacità.',
// 			'è necessario sentire ancora il parere di almeno un altro pilota esperto prima di intraprendere il volo.',
// 			'è opportuno considerare i propri dubbi come valido e sufficiente motivo per non intrapren dere assolutamente il volo.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '9008',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Vi trovate al decollo di un volo che non conoscete. Le condizioni sono forti, ma tutti decol lano con successo. Tra i seguenti atteggiamenti che potete tenere quale ritenete sia più conserva tivo sotto il profilo della sicurezza?',
// 		answers: [
// 			'Attendere che le condizioni inizino a ridursi e solo allora intraprendere il volo tenendo pre senti i consigli di chi vi è parso più equilibrato ed esperto.',
// 			'Predisporsi ad intraprendere il volo non prima di aver preso nota dei consigli forniti dagli esperti del luogo.',
// 			'Predisporsi ad intraprendere il volo imitando il piano di volo e le manovre degli esperti del luogo onde migliorare la propria personale esperienza.'
// 		],
// 		correct_answer_index: 0
...
// 		id: '9009',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Per quale motivo si ritiene pericoloso il de collo in discendenza o con vento in coda?',
// 		answers: [
// 			'Solo perché la pendenza della traiettoria di volo risulterà troppo elevata appena staccati da terra.',
// 			"Per l'eccessiva velocità che il pilota deve svilup pare correndo e per problemi di traiettoria una volta decollati.",
...
// 		id: '9010',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Come deve essere valutato il decollo da un dirupo a scalino di circa 90° con deltaplano o pa rapendio?',
// 		answers: ['Molto pericoloso.', 'Molto tecnico.', 'Normale se si ha buona esperienza.'],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '9011',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'La giornata è umida e le termiche gene rano velocemente nubi cumuliformi. Entrati in ter mica, è necessario prestare attenzione al fatto che:',
// 		answers: [
// 			'si può scatenare un temporale e potremmo es sere colpiti da un fulmine.',
// 			"l'ascendenza può essere associata a turbolenza che rende poco piacevole il volo.",
// 			"l'ascendenza può divenire tanto forte da impe dirci di scendere, correndo così il grave rischio di essere trascinati in una nube a carattere temporalesco."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 			'Avere una collisione con altri apparecchi.',
// 			"Subire un degrado delle prestazioni a causa di eventuali formazioni di ghiaccio sulla struttura dell'apparecchio.",
// 			"Perdere il senso dell'orientamento e il controllo dell'apparecchio, poiché gli organi dell'equili brio funzionano male in mancanza di riferi menti visivi."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '9013',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "È dimostrato che il wind shear è un feno meno pericoloso per il volo in generale, ma in par ticolare per il Volo Libero. Che cosa s'intende per wind shear?",
// 		answers: [
// 			"Solo un improvviso aumento dell'intensità del vento nel tempo e/o nello spazio.",
// 			"Un'improvvisa variazione di direzione e/o d'in tensità del vento nel tempo e/o nello spazio.",
// 			"Un improvviso aumento dell'intensità del vento relativo sull'ala."
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		text: "Rispetto al suolo non avanziamo. Siamo alla presenza di un vento meteorologico contrario la cui velocità è pari alla nostra velocità all'aria. Se di colpo il vento cessasse l'ala:",
// 		answers: [
// 			"risulterebbe, anche se per un tempo brevis simo, senz'altro investita da un vento relativo nullo.",
// 			"continuerebbe a volare alla velocità all'aria che aveva prima.",
// 			'non avrebbe comunque problemi di natura ae rodinamica.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '9015',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Che cosa s'intende per configurazione inu suale di un deltaplano e di un parapendio?",
// 		answers: [
// 			"Una configurazione o una situazione di volo normale per l'ala ma alla quale il pilota non è abituato.",
// 			"Una configurazione dell'ala o una situazione di volo anomala e al di fuori del normale inviluppo di volo e di manovrabilità previsti.",
// 			"Una situazione di volo in cui i valori dell'inci denza sono ai limiti dello stallo."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '9016',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Un'ala certificata offre le seguenti garan zie rispetto a un'ala non certificata:",
// 		answers: [
// 			"le reazioni dell'ala certificata sono sempre con trollabili e non pericolose, quelle dell'ala non certificata sono pericolose.",
// 			"le reazioni dell'ala non certificata non sono note, quelle dell'ala certificata sono note (rela tivamente alle manovre di omologazione).",
// 			"un'ala certificata è adatta al pilota medio, le ali non certificate sono riservate ai competitori."
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '9017',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Ai fini del volo con deltaplano e parapen dio è necessario tenere presenti le difficoltà e i ri schi connessi ad attività svolta in una valle lunga e stretta perché:',
// 		answers: [
// 			'è sempre interessata da forti correnti discen sionali.',
// 			'in essa eventuali brezze o venti sono comun que violente e turbolente particolarmente in corrispondenza del fondo valle.',
// 			"il fondo di una valle stretta non presenta gene ralmente aree idonee all'atterraggio a prescin dere dal vento esistente."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '9018',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Se deltaplano e parapendio sono partico larmente soggetti agli effetti negativi del wind shear, come può essere giudicato un atterraggio effettuato sottovento a ostacoli rilevanti in condi zione di vento sostenuto?',
// 		answers: [
// 			'Fattibile, ma con qualche difficoltà da piloti con poca esperienza.',
// 			'Molto tecnico e quindi fattibile in sicurezza to tale solo da piloti esperti.',
// 			"Pericoloso in assoluto per qualsiasi pilota per l'imprevedibilità dei fenomeni aerologici asso ciati a questa situazione."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '9019',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Se in atterraggio il vento è tanto forte da limitare notevolmente la penetrazione, quali solu zioni adottare in avvicinamento?',
// 		answers: [
// 			'Effettuare degli "otto" con la tecnica a "gran chio" che ci dota comunque di una certa velo cità al suolo permettendoci di affrontare in si curezza situazioni di forte gradiente in prossi mità del terreno.',
// 			'Eseguire comunque un circuito a "C" che eli mina la necessità di fare molte virate, senza quindi doverci porre il problema dell\'avanza mento rispetto al terreno.',
// 			'Tentare un avvicinamento a "otto" normale at terrando all\'indietro o su una traiettoria verti cale se questo è ciò che si ottiene.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
...
// 		id: '9021',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Vedendoci costretti a un atterraggio in ac qua, quale precauzione è indispensabile adottare?',
// 		answers: [
// 			"Solo dopo il contatto con l'acqua sganciarsi e/o fuoriuscire dall'imbrago.",
// 			"Poco prima dell'impatto predisporre quanto possibile l'imbrago onde ci si possa liberare da esso al più presto a impatto avvenuto.",
// 			'Atterrare in direzione parallela al moto ondoso.'
...
// 		answers: [
// 			'Perché il recupero da configurazioni inusuali in cui ci si venga a trovare intenzionalmente o meno, comporta una perdita di quota che può essere fatale.',
// 			"Perché vicino al suolo le reazioni dell'ala ai co mandi sono più brusche a causa della maggior densità dell'aria.",
...
// 		id: '9023',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Quali conseguenze in volo si possono avere per non aver agganciato i cosciali della sel letta del parapendio?',
// 		answers: [
// 			'Una posizione molto scomoda, ma il rischio è minimo se il pettorale è ben agganciato.',
// 			'Una situazione di gravissimo pericolo quale la fuoriuscita dalla selletta e la caduta.',
// 			'Una situazione di grave pericolo sempre che non ci si riesca ad aggrappare saldamente al fascio funicolare.'
...
// 		id: '9025',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Analizzare in anticipo previsioni meteoro logiche specifiche per il volo aumenta la sicurezza?',
// 		answers: [
// 			'No perché la situazione meteorologica locale può essere valutata solo al momento.',
// 			'Si, perché una previsione positiva garantisce un volo sicuro.',
// 			'Si, perché fornisce informazioni utili a valutare meglio la situazione meteorologica e la sua possibile evoluzione.'
...
// 			"Una tendenza alla rotazione dell'ala che però è sempre possibile compensare con peso e freno.",
// 			"Una situazione di grave pericolo che va dal ri torno violento al pendio all'impossibilità di re cupero della cravatta con buone probabilità che l'ala sia difficilmente controllabile."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		id: '9028',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "E' vero che la certificazione europea del parapendio garantisce, entro certi limiti, un ottimo livello di sicurezza a patto che siano rispettati il rapporto tra esperienza del pilota e classe di ap partenenza dell'ala volata, nonché tutte le norme relative al tipo ed alla regolazione della selletta ri portate nella certificazione?",
// 		answers: [
// 			"No, è un'affermazione poco attendibile.",
// 			'Si, ma è vero solo per ali standard.',
// 			'Si, è vero.'
...
// 		id: '9029',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "E' corretto affermare dal punto di vista della sicurezza del volo che un'ala certificata in una classe basica garantisce il pilota anche se ine sperto in caso di configurazione inusuale?",
// 		answers: [
// 			'Si, indipendentemente da altri fattori.',
// 			'Assolutamente no.',
// 			'Si, ma solo se sono state rispettate le norme relative al tipo e alla regolazione della selletta riportate nella certificazione.'
...
// 		text: "Ai fini della sicurezza del volo, un pilota che si appresta a volare un'ala certificata in una classe non basica deve essere conscio che in caso di configurazione inusuale:",
// 		answers: [
// 			'necessita il suo intervento tempestivo e quali ficato per tornare a condizioni di normalità senza finire in una grave sequenza di configu razioni inusuali.',
// 			'può attendersi il ritorno a condizioni di norma lità anche se non in 4 secondi.',
// 			'necessita il suo intervento sui comandi, che deve essere quello istintivo per ogni situazione.'
// 		],
// 		correct_answer_index: 0
// 	},
...
// 		answers: [
// 			"errato. E' fondamentale la riapertura dell'ala che quindi va fatta prima.",
// 			"corretto. Usando per ristabilire il controllo dire zionale prima il peso e poi il freno per evitare lo stallo dovuto all'aumento del carico alare prodotto dalla chiusura.",
// 			"errato. E' opportuno cercare prima di riaprire l'ala e se ciò non fosse possibile usare subito il paracadute di soccorso."
// 		],
// 		correct_answer_index: 1
// 	},
...
// 		id: '9032',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Configurazioni inusuali del parapendio. Chiusura frontale del bordo d'attacco, tendenza dell'ala a passare bruscamente dietro al pilota. Il pilota dovrà prima di tutto rilasciare entrambi i freni per poi tenersi pronto a controllare l'abbatti mento in avanti dell'ala:",
// 		answers: [
// 			"corretto, la riapertura dell'ala se si agisce rila sciando simmetricamente i freni generalmente non è problematica, ma lo possono essere i pendolamenti che ne conseguono.",
// 			"corretto, anche se i pendolamenti che conse guono alla riapertura dell'ala non costituiscono mai un problema.",
// 			"errato, è necessario comunque attendere che l'ala si riapra da sola per evitare inutili pendo lamenti e se ciò non avviene usare al più presto il paracadute di soccorso."
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '9033',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Configurazioni inusuali del parapendio. La conseguenza di un'eccessiva trazione asimmetrica dei comandi dei freni è lo stallo asimmetrico che induce una brusca e violenta rotazione dell'ala at torno all'asse verticale, detta \"vite piatta nega tiva\". Per prevenire tale configurazione prima che si verifichi il pilota dovrà:",
// 		answers: [
// 			"affondare anche l'altro comando per poi rila sciarli entrambi verso l'alto dolcemente.",
// 			"rilasciare anche di poco il comando troppo af fondato abbassando della stessa entità anche l'altro.",
// 			"rilasciare prontamente e simmetricamente verso l'alto entrambi i comandi, pronti a inter venire per controllare l'abbattimento dell'ala in avanti se e quando si verifica."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
...
// 		text: 'Configurazioni inusuali del parapendio. In che cosa consiste il post-stallo di un parapendio e che cosa può accadere se si verifica?',
// 		answers: [
// 			'È la situazione prodotta dal permanere in con dizioni di stallo, ma non può avere alcuna con seguenza se si verifica.',
// 			"È la condizione in cui si trova l'ala dopo una corretta rimessa dallo stallo; le conseguenze dipendono da come la rimessa si verifica.",
// 			"È la situazione prodotta dal permanere in con dizioni di stallo e il conseguente collasso totale dell'ala."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '9035',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Configurazioni inusuali del parapendio. All\'uscita da uno stallo di "B" si constata di avere un tasso di caduta elevatissimo, una velocità di avanzamento quasi nulla con l\'ala perfettamente gonfia sulla verticale. Che cosa può essere acса duto?',
// 		answers: [
// 			'Si è finiti in stallo paracadutale per aver proba bilmente rilasciato le bretelle "B" troppo lenta mente verso l\'alto e/o perché si sta volando un\'ala dal tessuto divenuto poroso.',
// 			'Si è finiti in stallo paracadutale per aver rila sciato troppo bruscamente le bretelle " " all\'uscita dalla manovra; la porosità dell\'ala non ha nulla a che vedere con questa situazione.',
// 			'Nulla di significativo, il tasso di caduta elevato è normale all\'uscita dallo stallo di "B" e per for tuna l\'ala è gonfia sulla verticale.'
// 		],
// 		correct_answer_index: 0
// 	},
// 	{
// 		id: '9036',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Configurazioni inusuali del parapendio. Per ottenere al meglio l'uscita da uno stallo para cadutale il pilota dovrà, dopo aver rilasciato pron tamente verso l'alto entrambi i freni, agire nell'or dine come segue:",
// 		answers: [
// 			'trazionare con decisione una sola delle bretelle anteriori oppure, se ciò non ha effetto, trazio nare decisamente uno solo dei freni.',
// 			"spingere in avanti le bretelle A, utilizzare a fondo l'acceleratore, successivamente se l'as setto persiste affondare i freni simmetrica mente e poi rilasciarli, utilizzare in ultima analisi un freno solo affondandolo e rilasciandolo e aspettandosi di uscire in quest'ultimo caso con una violenta virata o in \"vite piatta negativa\".",
// 			'affondare con decisione un freno solo, pom pare simmetricamente con i freni, spingere in ultima analisi con decisione in avanti le bretelle anteriori.'
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
// 		id: '9037',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Decollo in deltaplano con vento sostenuto. L'utilizzo di un assistente che tocchi il delta all'ini zio della rincorsa è rischioso perché:",
// 		answers: [
// 			"l'assistente può essere trascinato giù dalla rampa o addirittura essere portato in volo.",
// 			'non tutti gli assistenti danno adeguate garanzie di comportamento anche se ben istruiti dal pi lota.',
// 			"l'assistente, anche se esperto non può avere la sensibilità rispetto al mezzo che invece ha il pi lota e quindi può imprimergli un assetto e una posizione non ottimali."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '9038',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Il mancato o non corretto aggancio del pi lota al deltaplano comporta:',
// 		answers: [
// 			'gravissime conseguenze sempre.',
// 			'la necessità di atterrare al più presto.',
// 			'la necessità di ridurre le manovre allo stretto indispensabile per non precipitare.'
...
// 		id: '9039',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Se per avaria strutturale il dispositivo an tidrappo non dovesse entrare in funzione quando necessario, una volta innescata la caduta a drappo:',
// 		answers: [
// 			"è bene cercare prima di uscirne con l'uso dei comandi e del peso, non c'è fretta per l'uso del paracadute di soccorso.",
// 			'è bene fare uso immediato del paracadute di soccorso, prima che la velocità verticale sia troppo elevata.',
// 			"è bene attendere che la velocità di caduta sia molto elevata prima di aprire il paracadute di soccorso, al fine di ottenerne l'immediata aper tura."
// 		],
// 		correct_answer_index: 1
// 	},
// 	{
...
// 			'solo dalla velocità che è necessaria assumere prima di iniziare la manovra di cabrata.',
// 			'solo dalle accelerazioni cui è sottoposto il mezzo durante tutta la manovra.',
// 			'dalla velocità elevata che è necessario assu mere prima di iniziare la manovra di cabrata e dalle accelerazioni cui è sottoposto il deltaplano durante tutta la manovra.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '9041',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Che cosa s'intende per tumbling del delta plano?",
// 		answers: [
// 			"Una brusca rotazione incontrollata attorno all'asse d'imbardata.",
// 			"Una brusca rotazione incontrollata attorno all'asse trasversale.",
// 			"Una brusca rotazione incontrollata attorno all'asse longitudinale."
...
// 		id: '9042',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: 'Quali elementi, tra i seguenti, contribui scono a provocare il tumbling del deltaplano?',
// 		answers: [
// 			"Un angolo d'incidenza troppo elevato associato a condizioni di turbolenza.",
// 			'Una velocità troppo elevata in condizioni di forte turbolenza.',
// 			'Virate in condizioni di ascendenza.'
...
// 		id: '9043',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "E' vero che praticando il Volo Libero il pi lota deve usare il paracadute di soccorso solo in ultima analisi e cioè quando non è possibile ripri stinare altrimenti condizioni di volo nelle quali il mezzo risulti pilotabile sino a un atterraggio si curo?",
// 		answers: [
// 			"No, questa è una credenza sbagliata perché il paracadute di soccorso va usato sempre e al più presto possibile quando l'ala assume una configurazione inusuale.",
// 			"Si, tenendo presente che non c'è alcuna fretta nell'utilizzarlo perché non ha limiti per l'aper tura.",
// 			'Si, tenendo presente comunque che dal mo mento in cui si decide di usarlo è bene farlo al più presto per consentirgli di aprirsi in tempo utile ed entro i suoi limiti strutturali.'
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '9044',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Oltre al caso di malore del pilota, in quale di queste situazioni è utile l'apertura del paraca dute di emergenza e come deve essere fatta?",
// 		answers: [
// 			"In forte turbolenza qualora risulti difficile il con trollo del deltaplano o del parapendio, tirando con decisione la maniglia verso l'alto.",
// 			"In caso ci si trovi all'interno di una corrente ascensionale tanto forte da trascinarci in nube, tirando la maniglia con decisione verso il basso in modo che il paracadute si allontani più pos sibile dall'ala.",
// 			"In caso di rottura strutturale non potendo più controllare l'apparecchio o a seguito di configu razione inusuale che si riveli totalmente irrecu perabile con l'uso dei comandi e del peso, ti rando con decisione la maniglia in modo che il paracadute si allontani più possibile dall'ala."
// 		],
// 		correct_answer_index: 2
// 	},
// 	{
// 		id: '9045',
// 		section: 'SICUREZZA DEL VOLO',
// 		text: "Se è vero che il paracadute di soccorso, come emerge inconfutabilmente da dati statistici, funziona nella quasi totalità dei casi, per quale mo tivo è comunque raccomandato il suo uso solo in casi in cui esso costituisce l'ultima risorsa disponi bile?",
// 		answers: [
// 			'Perché le statistiche non sono attendibili, e il suo funzionamento è aleatorio.',
// 			"Perché pur garantendo un'altissima probabilità di funzionamento non è, nella quasi totalità dei casi, direzionabile e quindi non ci garantisce la scelta del punto di atterraggio.",
// 			'Perché è quasi sempre inutile usarlo anche se funziona, qualsiasi sia la configurazione inu suale assunta è infatti sempre possibile uscirne in tempo utile mantenendo la calma e insi stendo sui comandi.'
// 		],
// 		correct_answer_index: 1
// 	}
// ];
